...
- TODO(runtime, owner:runtime, milestone:RT2, priority:P2, status:missing): add native host-level websocket connect hook for `molt_ws_connect` and wire capability enforcement for production socket usage.
