...
def _lower_entry_module_as_main(
    *,
    ...
    main_gen = SimpleTIRGenerator(
        ...
        direct_call_modules=set(lowering_context.direct_call_modules),
    ...
    if layer_plan.mode == "parallel":
        ...
        layer_state, batch_error, layer_failure_detail = (
            _run_frontend_parallel_layer_batches(
                ...
                direct_call_modules=execution_context.direct_call_modules,
                ...
                native_callable_exports=execution_context.native_callable_exports,
                native_python_exports=execution_context.native_python_exports,
                module_deps=execution_context.module_deps,
