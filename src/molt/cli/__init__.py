...
# The package's PEP 562 lazy re-exports (``__getattr__``/``__dir__`` and the
# post-lowering module proxies) live in one module; binding them here makes
# them the package's own. See ``molt.cli._lazy_facade``.
