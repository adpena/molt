...
def _bind_confirmed_test_repository() -> None:
    """Expose repository tooling only after a test invocation is identified.
...
def python_pytest_invocation_args(
    *,
...
def ensure_pytest_memory_guard(
    *,
    ...
    args = (
        ...
        else python_pytest_invocation_args(
            orig_argv=orig_argv, runtime_argv=runtime_argv
        )
    )
    if args is None:
        return False
