...
_MOLT_TK_TRACE_ADD = _require_intrinsic("molt_tk_trace_add")
_MOLT_TK_TRACE_REMOVE = _require_intrinsic("molt_tk_trace_remove")
_MOLT_TK_TRACE_CLEAR = _require_intrinsic("molt_tk_trace_clear")
_MOLT_TK_TRACE_INFO = _require_intrinsic("molt_tk_trace_info")
_MOLT_TK_TKWAIT_VARIABLE = _require_intrinsic("molt_tk_tkwait_variable")
...
_MOLT_TK_FILEHANDLER_CREATE = _require_intrinsic("molt_tk_filehandler_create")
_MOLT_TK_FILEHANDLER_DELETE = _require_intrinsic("molt_tk_filehandler_delete")
_MOLT_TK_DESTROY_WIDGET = _require_intrinsic("molt_tk_destroy_widget")
...
_MOLT_TK_ERRORINFO_APPEND = _require_intrinsic("molt_tk_errorinfo_append")
