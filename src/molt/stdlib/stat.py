...
_MOLT_STAT_CONSTANTS = _require_intrinsic("molt_stat_constants")
_MOLT_STAT_IFMT = _require_intrinsic("molt_stat_ifmt")
_MOLT_STAT_IMODE = _require_intrinsic("molt_stat_imode")
_MOLT_STAT_ISDIR = _require_intrinsic("molt_stat_isdir")
_MOLT_STAT_ISREG = _require_intrinsic("molt_stat_isreg")
_MOLT_STAT_ISCHR = _require_intrinsic("molt_stat_ischr")
_MOLT_STAT_ISBLK = _require_intrinsic("molt_stat_isblk")
_MOLT_STAT_ISFIFO = _require_intrinsic("molt_stat_isfifo")
_MOLT_STAT_ISLNK = _require_intrinsic("molt_stat_islnk")
_MOLT_STAT_ISSOCK = _require_intrinsic("molt_stat_issock")
_MOLT_STAT_ISDOOR = _require_intrinsic("molt_stat_isdoor")
_MOLT_STAT_ISPORT = _require_intrinsic("molt_stat_isport")
_MOLT_STAT_ISWHT = _require_intrinsic("molt_stat_iswht")
_MOLT_STAT_FILEMODE = _require_intrinsic("molt_stat_filemode")
