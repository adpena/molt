...
_MOLT_HTTP_SERVER_SEND_RESPONSE = _require_intrinsic("molt_http_server_send_response")
_MOLT_HTTP_SERVER_SEND_RESPONSE_ONLY = _require_intrinsic(
    "molt_http_server_send_response_only"
)
_MOLT_HTTP_SERVER_SEND_HEADER = _require_intrinsic("molt_http_server_send_header")
...
_MOLT_HTTP_SERVER_VERSION_STRING = _require_intrinsic("molt_http_server_version_string")
