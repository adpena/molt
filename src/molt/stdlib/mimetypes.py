...
# Windows-specific MIME registry support is intentionally omitted in molt's
# port. The CPython source tries to import `_winapi._mimetypes_read_windows_registry`
# and `winreg`; on non-Windows platforms both fall back to None, which is the
# only behavior molt supports.
