"""
tinygrad.speculative — generic flash-attention and speculative helpers.
...
This module is intentionally not named DFlash. DFlash requires a
target-conditioned block-diffusion drafter/verifier contract; see
``molt.gpu.dflash`` and ``docs/spec/areas/perf/0520_DFLASH_CONTRACT.md``.
