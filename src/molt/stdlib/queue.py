...
_MOLT_QUEUE_LIFO_NEW = _require_intrinsic("molt_queue_lifo_new")
_MOLT_QUEUE_PRIORITY_NEW = _require_intrinsic("molt_queue_priority_new")
_MOLT_QUEUE_QSIZE = _require_intrinsic("molt_queue_qsize")
_MOLT_QUEUE_EMPTY = _require_intrinsic("molt_queue_empty")
_MOLT_QUEUE_FULL = _require_intrinsic("molt_queue_full")
_MOLT_QUEUE_PUT = _require_intrinsic("molt_queue_put")
_MOLT_QUEUE_GET = _require_intrinsic("molt_queue_get")
_MOLT_QUEUE_TASK_DONE = _require_intrinsic("molt_queue_task_done")
_MOLT_QUEUE_JOIN = _require_intrinsic("molt_queue_join")
_MOLT_QUEUE_DROP = _require_intrinsic("molt_queue_drop")
_MOLT_MODULE_CACHE_SET = _require_intrinsic("molt_module_cache_set")
if _PY_GE_313:
    _MOLT_QUEUE_SHUTDOWN = _require_intrinsic("molt_queue_shutdown")
    _MOLT_QUEUE_IS_SHUTDOWN = _require_intrinsic("molt_queue_is_shutdown")
