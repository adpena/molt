...
_molt_socket_clone = _require_intrinsic("molt_socket_clone")
...
_molt_socket_recvfrom_into = _require_intrinsic("molt_socket_recvfrom_into")
...
_molt_socket_sendmsg = _require_intrinsic("molt_socket_sendmsg")
_molt_socket_recvmsg = _require_intrinsic("molt_socket_recvmsg")
_molt_socket_recvmsg_into = _require_intrinsic("molt_socket_recvmsg_into")
...
_molt_socket_gethostbyname = _require_intrinsic("molt_socket_gethostbyname")
_molt_socket_gethostbyaddr = _require_intrinsic("molt_socket_gethostbyaddr")
_molt_socket_getfqdn = _require_intrinsic("molt_socket_getfqdn")
...
_molt_socket_sendmsg_afalg = _require_intrinsic("molt_socket_sendmsg_afalg")
