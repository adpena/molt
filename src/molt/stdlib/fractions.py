...
_MOLT_FRACTION_NEW = _require_intrinsic("molt_fraction_new", globals())
_MOLT_FRACTION_FROM_FLOAT = _require_intrinsic("molt_fraction_from_float", globals())
_MOLT_FRACTION_FROM_STR = _require_intrinsic("molt_fraction_from_str", globals())
_MOLT_FRACTION_ADD = _require_intrinsic("molt_fraction_add", globals())
_MOLT_FRACTION_SUB = _require_intrinsic("molt_fraction_sub", globals())
_MOLT_FRACTION_MUL = _require_intrinsic("molt_fraction_mul", globals())
_MOLT_FRACTION_TRUEDIV = _require_intrinsic("molt_fraction_truediv", globals())
_MOLT_FRACTION_FLOORDIV = _require_intrinsic("molt_fraction_floordiv", globals())
_MOLT_FRACTION_MOD = _require_intrinsic("molt_fraction_mod", globals())
_MOLT_FRACTION_POW = _require_intrinsic("molt_fraction_pow", globals())
_MOLT_FRACTION_NEG = _require_intrinsic("molt_fraction_neg", globals())
_MOLT_FRACTION_ABS = _require_intrinsic("molt_fraction_abs", globals())
_MOLT_FRACTION_EQ = _require_intrinsic("molt_fraction_eq", globals())
_MOLT_FRACTION_LT = _require_intrinsic("molt_fraction_lt", globals())
_MOLT_FRACTION_LE = _require_intrinsic("molt_fraction_le", globals())
_MOLT_FRACTION_NUMERATOR = _require_intrinsic("molt_fraction_numerator", globals())
_MOLT_FRACTION_DENOMINATOR = _require_intrinsic("molt_fraction_denominator", globals())
_MOLT_FRACTION_TO_FLOAT = _require_intrinsic("molt_fraction_to_float", globals())
_MOLT_FRACTION_TO_STR = _require_intrinsic("molt_fraction_to_str", globals())
_MOLT_FRACTION_HASH = _require_intrinsic("molt_fraction_hash", globals())
