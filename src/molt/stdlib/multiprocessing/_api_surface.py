...
def _make_value(module_name: str, symbol_name: str, type_name: str, expected_callable: bool):
    if type_name == "module":
        return _types
    if type_name == "int":
        return 0
    ...
    value = _placeholder_function(module_name, symbol_name) if expected_callable else object()
    return value
    ...
    for symbol_name, type_name, expected_callable in rows:
        ...
        if symbol_name in provider_map:
            ...
            if existing is not None:
                ...
                if existing_type == type_name and existing_callable == expected_callable:
                    continue
