...
_MOLT_ARRAY_NEW = _require_intrinsic("molt_array_new")
_MOLT_ARRAY_FROM_LIST = _require_intrinsic("molt_array_from_list")
...
_MOLT_ARRAY_INDEX = _require_intrinsic("molt_array_index")
_MOLT_ARRAY_INSERT = _require_intrinsic("molt_array_insert")
...
_MOLT_ARRAY_TOBYTES = _require_intrinsic("molt_array_tobytes")
_MOLT_ARRAY_TOLIST = _require_intrinsic("molt_array_tolist")
_MOLT_ARRAY_TYPECODE = _require_intrinsic("molt_array_typecode")
