...
_MOLT_ORDEREDDICT_FROM_PAIRS = _require_intrinsic(
    "molt_ordereddict_from_pairs", globals()
)
_MOLT_ORDEREDDICT_SETITEM = _require_intrinsic("molt_ordereddict_setitem", globals())
_MOLT_ORDEREDDICT_GETITEM = _require_intrinsic("molt_ordereddict_getitem", globals())
_MOLT_ORDEREDDICT_DELITEM = _require_intrinsic("molt_ordereddict_delitem", globals())
_MOLT_ORDEREDDICT_CONTAINS = _require_intrinsic("molt_ordereddict_contains", globals())
_MOLT_ORDEREDDICT_LEN = _require_intrinsic("molt_ordereddict_len", globals())
_MOLT_ORDEREDDICT_KEYS = _require_intrinsic("molt_ordereddict_keys", globals())
_MOLT_ORDEREDDICT_VALUES = _require_intrinsic("molt_ordereddict_values", globals())
_MOLT_ORDEREDDICT_ITEMS = _require_intrinsic("molt_ordereddict_items", globals())
...
_MOLT_ORDEREDDICT_COPY = _require_intrinsic("molt_ordereddict_copy", globals())
_MOLT_ORDEREDDICT_DROP = _require_intrinsic("molt_ordereddict_drop", globals())
