...
# Autospec and patch share this public namespace with the mock classes.
# Copying those globals into helper modules breaks live rebinding and gives
# exported functions the wrong module identity for introspection and pickling.
