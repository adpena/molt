...
_MOLT_PROCESS_RETURNCODE = _require_intrinsic("molt_process_returncode")
_MOLT_PROCESS_KILL = _require_intrinsic("molt_process_kill")
_MOLT_PROCESS_TERMINATE = _require_intrinsic("molt_process_terminate")
_MOLT_PROCESS_STDIN = _require_intrinsic("molt_process_stdin")
_MOLT_PROCESS_STDOUT = _require_intrinsic("molt_process_stdout")
_MOLT_PROCESS_STDERR = _require_intrinsic("molt_process_stderr")
_MOLT_PROCESS_DROP = _require_intrinsic("molt_process_drop")
_MOLT_STREAM_SEND_OBJ = _require_intrinsic("molt_stream_send_obj")
_MOLT_STREAM_CLOSE = _require_intrinsic("molt_stream_close")
