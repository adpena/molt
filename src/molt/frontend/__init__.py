...
class SimpleTIRGenerator(
    ...
    # _populate_sema_state. AST suspension-shape facts stay on the assembled
    # generator surface via FunctionMetadataMixin while sema/funcmeta.py carries
    # its own private pre-walk copies.)
