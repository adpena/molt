"""ASGI adapter for Molt handlers.

Canonical location for the Molt-specific ASGI helper surface.
"""
...
async def _iter_body(body: "Stream | AsyncIterable[Any] | bytes | str | None"):
    from moltlib.net import Stream
...
def asgi_adapter(
    ...
    async def app(scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if not isinstance(result, Response):
            raise TypeError("Handler must return a moltlib.net.Response")
