...
# The decomposed regions in tools/proof_queue_pkg/ reach shared helpers,
# constants, and monkeypatch-sensitive primitives back through this module.
# When path-invoked this file runs as ``__main__``; alias it to its canonical
# import name so those package modules bind to this same, fully-defined module
...
# These large regions live in tools/proof_queue_pkg/ to satisfy the
# structural-audit kitchen-sink ceiling; they reach shared helpers,
# constants, and monkeypatch-sensitive primitives back through this module.
from tools.proof_queue_pkg.diagnostics import _run_diagnostics  # noqa: E402
from tools.proof_queue_pkg.runner import _run_one  # noqa: E402
