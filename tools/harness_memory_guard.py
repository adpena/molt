...
_utc_timestamp = _harness_outcomes.utc_timestamp
_elapsed_text = _harness_outcomes.elapsed_text
_limit_text = _harness_outcomes.limit_text
_rss_limit_hint = _harness_outcomes.rss_limit_hint
_timeout_hint = _harness_outcomes.timeout_hint
_guard_stderr_message = _harness_outcomes.guard_stderr_message
_guard_timeout_message = _harness_outcomes.guard_timeout_message
_guard_exit_signal_message = _harness_outcomes.guard_exit_signal_message
_guard_parent_signal_message = _harness_outcomes.guard_parent_signal_message
_guard_orphan_cleanup_message = _harness_outcomes.guard_orphan_cleanup_message
_rss_record_payload = _harness_outcomes.rss_record_payload
_guarded_command_status = _harness_outcomes.guarded_command_status
...
def _append_guarded_command_profile(
    *,
    ...
    payload: dict[str, object] = {
        ...
        "temporary_artifacts": (
            None if temporary_artifacts is None else dict(temporary_artifacts)
        ),
