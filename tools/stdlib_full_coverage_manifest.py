...
STDLIB_REQUIRED_INTRINSICS_BY_MODULE: dict[str, tuple[str, ...]] = {
    ...
    "binascii": (
        ...
        "molt_binascii_a2b_hex",
        "molt_binascii_b2a_hex",
        "molt_binascii_a2b_qp",
        "molt_binascii_b2a_qp",
        "molt_binascii_a2b_uu",
        "molt_binascii_b2a_uu",
        "molt_binascii_crc32",
        "molt_binascii_crc_hqx",
    ),
    "colorsys": (
    ...
    "weakref": (
        ...
        "molt_weakcontainer_get",
        "molt_weakcontainer_iter",
        "molt_weakcontainer_len",
        "molt_weakcontainer_new",
        "molt_weakcontainer_pop",
        "molt_weakcontainer_refs",
        "molt_weakcontainer_store_commit",
        "molt_weakcontainer_store_probe",
        "molt_weakcontainer_take",
    ),
}
