...
const lifetimeExports = {{RUNTIME_LIFETIME_EXPORTS}};
...
export default {
    async fetch(request, env, ctx) {
        ...
        try {
            ...
            const lifetime = createRuntimeLifetime(instance, lifetimeExports, () => {
            ...
            try {
                ...
                if (!(error instanceof ProcExit && error.code === 0)) errors.push(error);
            } finally {
            ...
            console.error('molt worker error:', err);
