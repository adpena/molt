...
def _dspy_route_decision(
    *,
    ...
    if dspy is None or BaseModel is None:
        return fallback
    if not os.environ.get("MOLT_REMOVED_DSPY_ENABLE"):
        return fallback

    model = os.environ.get("MOLT_REMOVED_DSPY_MODEL", "").strip()
...
def cmd_apply_routing(args: argparse.Namespace) -> int:
    ...
    result = {
        ...
        "dspy": {
            "env_enabled": bool(os.environ.get("MOLT_REMOVED_DSPY_ENABLE")),
