...
#   zip entry: pidigits/pidigits.python3-4.python3
...
# Codon tier: NON_EQUIVALENT. Arbitrary-precision bignum -- Codon int is 64-bit; never scored as a Codon win/loss.
