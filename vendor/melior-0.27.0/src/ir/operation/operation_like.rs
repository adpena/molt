...
use mlir_sys::{
    MlirOperation, MlirValue, MlirWalkOrder, MlirWalkOrder_MlirWalkPostOrder,
...
mod raw_enum_tests {
    ...
    #[test]
    fn walk_enums_convert_through_mlir_sys_raw_types() {
        assert_eq!(
            size_of::<WalkOrder>(),
            size_of::<u32>(),
        ...
        assert_eq!(WalkOrder::PreOrder.to_raw(), MlirWalkOrder_MlirWalkPreOrder);
        assert_eq!(
            WalkResult::Interrupt.to_raw(),
...
impl WalkOrder {
    fn to_raw(self) -> MlirWalkOrder {
        match self {
            Self::PreOrder => MlirWalkOrder_MlirWalkPreOrder,
            Self::PostOrder => MlirWalkOrder_MlirWalkPostOrder,
        }
    }
}
...
impl WalkResult {
    fn to_raw(self) -> MlirWalkResult {
        match self {
            Self::Advance => MlirWalkResult_MlirWalkResultAdvance,
            Self::Interrupt => MlirWalkResult_MlirWalkResultInterrupt,
            Self::Skip => MlirWalkResult_MlirWalkResultSkip,
        }
    }
}
