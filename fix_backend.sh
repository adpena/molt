...
+
+                        let site_bits = crate::compile_ic_site_id(func_ir.name.as_str(), op_idx, "setattr") as i64;
...
INNER_EOF
patch runtime/molt-backend/src/wasm.rs < wasm.patch
