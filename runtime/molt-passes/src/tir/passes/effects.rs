...
/// (`runtime/molt-ir/src/tir/op_kinds.toml`'s per-OpCode `may_throw` column,
...
/// single-source-of-truth op-kind registry
/// (`runtime/molt-ir/src/tir/op_kinds.toml`'s per-OpCode `side_effecting`
...
/// (`runtime/molt-ir/src/tir/op_kinds.toml`'s per-OpCode `purity` column,
/// generated into [`crate::tir::op_kinds_generated`]; see
