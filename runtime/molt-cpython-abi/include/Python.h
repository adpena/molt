...
extern PyObject    *PyUnicode_DecodeASCII         (const char *s, Py_ssize_t size, const char *errors);
extern PyObject    *PyUnicode_DecodeUTF16         (const char *s, Py_ssize_t size, const char *errors, int *byteorder);
extern int          PyUnicode_IS_ASCII            (PyObject *op);
