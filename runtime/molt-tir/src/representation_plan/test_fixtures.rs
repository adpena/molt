...
pub(crate) fn peeled_compute_func_ir() -> FunctionIR {
    function(
        ...
        vec![
            ...
            op("lt", Some("fast_guard"), None, &["_v16", "_exact_bound"]),
            op("not", Some("_v44"), None, &["_v40"]),
            op("and", Some("_v45"), None, &["fast_guard", "_v44"]),
            ...
            op("lt", Some("slow_guard"), None, &["_v29", "_exact_bound"]),
            op_v("br_if", None, None, &["slow_guard"], 16),
