...
use crate::tir::op_kinds_generated::{
    ...
    LiteralPayloadKind, opcode_canonicalize_binary_rules_table,
    opcode_canonicalize_commutative_domain_table, opcode_literal_payload_kind_table,
