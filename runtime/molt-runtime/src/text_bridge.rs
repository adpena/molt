//! FFI bridge shims for `molt-runtime-text`.
//!
...
#[unsafe(no_mangle)]
pub extern "C" fn __molt_text_raise_exception(
    type_ptr: *const u8,
    type_len: usize,
    msg_ptr: *const u8,
    msg_len: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn __molt_text_string_obj_to_owned(
    bits: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn __molt_text_type_name(
    bits: u64,
    out_ptr: *mut *const u8,
    out_len: *mut usize,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __molt_text_to_i64(bits: u64, out: *mut i64) -> i32 {
    let obj = obj_from_bits(bits);
    match to_i64(obj) {
        Some(v) => {
            unsafe { *out = v; }
