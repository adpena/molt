//! Network utilities: socketpair, getaddrinfo, getnameinfo, gethostname, inet_pton/ntop,
//! htons/ntohl, if_nameindex, CMSG helpers, dualstack, send_fds, recv_fds, sendfile.
