...
unsafe fn try_call_bind_ic_fast_positional(
    _py: &PyToken<'_>,
    entry: CallBindIcEntry,
    call_bits: u64,
    pos: &[u64],
    ...
    unsafe {
        ...
        if entry.kind == CALL_BIND_IC_KIND_LIST_APPEND {
            if object_type_id(call_ptr) != TYPE_ID_BOUND_METHOD || pos.len() != 1 {
                return None;
            }
            let func_bits = bound_method_func_bits(call_ptr);
            let func_ptr = obj_from_bits(func_bits).as_ptr()?;
            ...
            let self_bits = bound_method_self_bits(call_ptr);
            return Some(molt_list_append(self_bits, pos[0]));
        }
        ...
        if entry.kind == CALL_BIND_IC_KIND_DIRECT_FUNC {
            ...
            if pos.len() != entry.arity as usize {
                return None;
            }
            return Some(call_function_obj_vec(_py, call_bits, pos));
        }
...
unsafe fn call_bind_ic_dispatch_positional(
    _py: &PyToken<'_>,
    site_bits: u64,
    call_bits: u64,
    pos: &[u64],
    ...
    unsafe {
        ...
        if let Some(entry) = ic_tls_lookup(site_id)
            && let Some(res) = try_call_bind_ic_fast_positional(_py, entry, call_bits, pos)
        {
        ...
        builder_guard.release();
        call_bind_ic_dispatch(_py, site_bits, call_bits, builder_bits)
    }
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos0_ic(site_bits: u64, call_bits: u64) -> u64 {
    crate::with_gil_entry!(_py, {
        unsafe { call_bind_ic_dispatch_positional(_py, site_bits, call_bits, &[]) }
    })
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos1_ic(site_bits: u64, call_bits: u64, arg0: u64) -> u64 {
    crate::with_gil_entry!(_py, {
        unsafe { call_bind_ic_dispatch_positional(_py, site_bits, call_bits, &[arg0]) }
    })
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos2_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
    ...
    crate::with_gil_entry!(_py, {
        unsafe { call_bind_ic_dispatch_positional(_py, site_bits, call_bits, &[arg0, arg1]) }
    })
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos3_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
    ...
    crate::with_gil_entry!(_py, {
        unsafe { call_bind_ic_dispatch_positional(_py, site_bits, call_bits, &[arg0, arg1, arg2]) }
    })
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos4_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
    ...
    crate::with_gil_entry!(_py, {
        unsafe {
            call_bind_ic_dispatch_positional(_py, site_bits, call_bits, &[arg0, arg1, arg2, arg3])
        }
    })
}

#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos5_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
    ...
    crate::with_gil_entry!(_py, {
        unsafe {
            call_bind_ic_dispatch_positional(
                _py,
                site_bits,
                call_bits,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos6_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos7_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_call_bind_pos8_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos0_ic(
    site_bits: u64,
    call_bits: u64,
    require_bridge_cap_bits: u64,
) -> u64 {
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos1_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    require_bridge_cap_bits: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos2_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos3_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos4_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos5_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos6_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos7_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
...
#[unsafe(no_mangle)]
pub extern "C" fn molt_invoke_ffi_pos8_ic(
    site_bits: u64,
    call_bits: u64,
    arg0: u64,
    arg1: u64,
