...
thread_local! {
    ...
    pub(crate) static TRACE_FRAME_PUSH_STACK: RefCell<Vec<bool>> = const { RefCell::new(Vec::new()) };
    ...
    pub(crate) static REPR_SET: RefCell<HashSet<PtrSlot>> = RefCell::new(HashSet::new());
