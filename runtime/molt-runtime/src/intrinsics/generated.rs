...
fn resolve_symbol_match(symbol: &str) -> Option<u64> {
    ...
    #[cfg(feature = "builtin_memoryview")]
...
fn resolve_core_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_abc_abstractmethod_check" => {
            Some(crate::molt_abc_abstractmethod_check as *const () as usize as u64)
        }
        ...
        "molt_dict_getitem_borrowed" => {
            Some(crate::molt_dict_getitem_borrowed as *const () as usize as u64)
        }
        "molt_list_getitem_borrowed" => {
            Some(crate::molt_list_getitem_borrowed as *const () as usize as u64)
        }
        "molt_tuple_getitem_borrowed" => {
            Some(crate::molt_tuple_getitem_borrowed as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_asyncio_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_protocol_get_structural_members" => {
            Some(crate::molt_protocol_get_structural_members as *const () as usize as u64)
        }
        ...
        "molt_asyncio_semaphore_value" => {
            Some(crate::molt_asyncio_semaphore_value as *const () as usize as u64)
        }
        #[cfg(feature = "stdlib_asyncio")]
...
fn resolve_codecs_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_codecs_charmap_decode" => {
            Some(crate::molt_codecs_charmap_decode as *const () as usize as u64)
        }
        "molt_codecs_charmap_encode" => {
            Some(crate::molt_codecs_charmap_encode as *const () as usize as u64)
        }
...
fn resolve_collections_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_namedtuple_validate_fields" => {
            Some(crate::molt_namedtuple_validate_fields as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_configparser_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_configparser_defaults" => {
            Some(crate::molt_configparser_defaults as *const () as usize as u64)
        }
        "molt_configparser_get_raw" => {
            Some(crate::molt_configparser_get_raw as *const () as usize as u64)
        }
        "molt_configparser_interpolate_basic" => {
            Some(crate::molt_configparser_interpolate_basic as *const () as usize as u64)
        }
        "molt_configparser_interpolate_extended" => {
            Some(crate::molt_configparser_interpolate_extended as *const () as usize as u64)
        }
        "molt_configparser_read_file" => {
            Some(crate::molt_configparser_read_file as *const () as usize as u64)
        }
        "molt_configparser_write_string" => {
            Some(crate::molt_configparser_write_string as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_csv_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        #[cfg(feature = "stdlib_csv")]
        "molt_csv_normalize_row" => {
            Some(crate::molt_csv_normalize_row as *const () as usize as u64)
        }
        #[cfg(feature = "stdlib_csv")]
        "molt_csv_dialect_lookup_name" => {
            Some(crate::molt_csv_dialect_lookup_name as *const () as usize as u64)
        }
        #[cfg(feature = "stdlib_csv")]
        "molt_csv_validate_dialect" => {
            Some(crate::molt_csv_validate_dialect as *const () as usize as u64)
        }
        #[cfg(feature = "stdlib_csv")]
        "molt_csv_validate_fmtparams" => {
            Some(crate::molt_csv_validate_fmtparams as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_dataclasses_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_dataclasses_hash_fn" => {
            Some(crate::molt_dataclasses_hash_fn as *const () as usize as u64)
        }
        "molt_dataclasses_repr" => Some(crate::molt_dataclasses_repr as *const () as usize as u64),
        "molt_dataclasses_check_default_order" => {
            Some(crate::molt_dataclasses_check_default_order as *const () as usize as u64)
        }
...
fn resolve_datetime_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_date_fromisocalendar" => {
            Some(crate::molt_date_fromisocalendar as *const () as usize as u64)
        }
        "molt_timedelta_truediv_scalar" => {
            Some(crate::molt_timedelta_truediv_scalar as *const () as usize as u64)
        }
        "molt_timedelta_truediv_td" => {
            Some(crate::molt_timedelta_truediv_td as *const () as usize as u64)
        }
        "molt_timedelta_floordiv_td" => {
            Some(crate::molt_timedelta_floordiv_td as *const () as usize as u64)
        }
        "molt_timedelta_mod_td" => Some(crate::molt_timedelta_mod_td as *const () as usize as u64),
        "molt_timedelta_floordiv_scalar" => {
            Some(crate::molt_timedelta_floordiv_scalar as *const () as usize as u64)
        }
        ...
        "molt_datetime_date_repr" => {
            Some(crate::molt_datetime_date_repr as *const () as usize as u64)
        }
        "molt_datetime_datetime_repr" => {
            Some(crate::molt_datetime_datetime_repr as *const () as usize as u64)
        }
        "molt_datetime_format_time" => {
            Some(crate::molt_datetime_format_time as *const () as usize as u64)
        }
        "molt_datetime_time_repr" => {
            Some(crate::molt_datetime_time_repr as *const () as usize as u64)
        }
        "molt_datetime_timetuple" => {
            Some(crate::molt_datetime_timetuple as *const () as usize as u64)
        }
        ...
        "molt_timezone_validate" => {
            Some(crate::molt_timezone_validate as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_heapq_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_heapq_heapify_max" => {
            Some(crate::molt_heapq_heapify_max as *const () as usize as u64)
        }
        "molt_heapq_heappop_max" => {
            Some(crate::molt_heapq_heappop_max as *const () as usize as u64)
        }
...
fn resolve_json_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_json_format_decode_error" => {
            Some(crate::molt_json_format_decode_error as *const () as usize as u64)
        }
        "molt_json_parse_error_msg" => {
            Some(crate::molt_json_parse_error_msg as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_linecache_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_linecache_detect_encoding" => {
            Some(crate::molt_linecache_detect_encoding as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_logging_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        #[cfg(feature = "stdlib_logging")]
        "molt_logging_file_handler_emit" => {
            Some(crate::molt_logging_file_handler_emit as *const () as usize as u64)
        }
        #[cfg(feature = "stdlib_logging")]
...
fn resolve_pathlib_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_pathlib_splitroot" => {
            Some(crate::molt_pathlib_splitroot as *const () as usize as u64)
        }
        ...
        "molt_pathlib_is_absolute" => {
            Some(crate::molt_pathlib_is_absolute as *const () as usize as u64)
        }
        "molt_pathlib_is_relative_to" => {
            Some(crate::molt_pathlib_is_relative_to as *const () as usize as u64)
        }
        "molt_pathlib_relative_to" => {
            Some(crate::molt_pathlib_relative_to as *const () as usize as u64)
        }
        "molt_pathlib_with_name" => {
            Some(crate::molt_pathlib_with_name as *const () as usize as u64)
        }
        "molt_pathlib_with_stem" => {
            Some(crate::molt_pathlib_with_stem as *const () as usize as u64)
        }
        "molt_pathlib_with_suffix" => {
            Some(crate::molt_pathlib_with_suffix as *const () as usize as u64)
        }
        ...
        "molt_pathlib_expanduser" => {
            Some(crate::molt_pathlib_expanduser as *const () as usize as u64)
        }
        ...
        "molt_pathlib_is_symlink" => {
            Some(crate::molt_pathlib_is_symlink as *const () as usize as u64)
        }
        ...
        "molt_pathlib_symlink_to" => {
            Some(crate::molt_pathlib_symlink_to as *const () as usize as u64)
        }
        "molt_pathlib_hardlink_to" => {
            Some(crate::molt_pathlib_hardlink_to as *const () as usize as u64)
        }
        "molt_pathlib_readlink" => Some(crate::molt_pathlib_readlink as *const () as usize as u64),
        "molt_pathlib_read_text" => {
            Some(crate::molt_pathlib_read_text as *const () as usize as u64)
        }
        "molt_pathlib_read_bytes" => {
            Some(crate::molt_pathlib_read_bytes as *const () as usize as u64)
        }
        "molt_pathlib_write_text" => {
            Some(crate::molt_pathlib_write_text as *const () as usize as u64)
        }
        "molt_pathlib_write_bytes" => {
            Some(crate::molt_pathlib_write_bytes as *const () as usize as u64)
        }
...
fn resolve_random_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_random_getrandbits" => {
            Some(crate::molt_random_getrandbits as *const () as usize as u64)
        }
        ...
        "molt_random_triangular" => {
            Some(crate::molt_random_triangular as *const () as usize as u64)
        }
        "molt_random_expovariate" => {
            Some(crate::molt_random_expovariate as *const () as usize as u64)
        }
        "molt_random_normalvariate" => {
            Some(crate::molt_random_normalvariate as *const () as usize as u64)
        }
        "molt_random_lognormvariate" => {
            Some(crate::molt_random_lognormvariate as *const () as usize as u64)
        }
        "molt_random_vonmisesvariate" => {
            Some(crate::molt_random_vonmisesvariate as *const () as usize as u64)
        }
        "molt_random_paretovariate" => {
            Some(crate::molt_random_paretovariate as *const () as usize as u64)
        }
        "molt_random_weibullvariate" => {
            Some(crate::molt_random_weibullvariate as *const () as usize as u64)
        }
        "molt_random_gammavariate" => {
            Some(crate::molt_random_gammavariate as *const () as usize as u64)
        }
        "molt_random_betavariate" => {
            Some(crate::molt_random_betavariate as *const () as usize as u64)
        }
...
fn resolve_string_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_string_template_scan" => {
            Some(crate::molt_string_template_scan as *const () as usize as u64)
        }
        "molt_string_template_is_valid" => {
            Some(crate::molt_string_template_is_valid as *const () as usize as u64)
        }
        "molt_string_template_get_identifiers" => {
            Some(crate::molt_string_template_get_identifiers as *const () as usize as u64)
        }
        "molt_string_formatter_parse" => {
            Some(crate::molt_string_formatter_parse as *const () as usize as u64)
        }
        "molt_string_formatter_field_name_split" => {
            Some(crate::molt_string_formatter_field_name_split as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_stringprep_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        "molt_stringprep_in_table" => {
            Some(crate::molt_stringprep_in_table as *const () as usize as u64)
        }
        "molt_stringprep_map_table_b3" => {
            Some(crate::molt_stringprep_map_table_b3 as *const () as usize as u64)
        }
        _ => None,
    }
}
...
fn resolve_sys_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_sys_getdefaultencoding" => {
            Some(crate::molt_sys_getdefaultencoding as *const () as usize as u64)
        }
        "molt_sys_getfilesystemencoding" => {
            Some(crate::molt_sys_getfilesystemencoding as *const () as usize as u64)
        }
        "molt_sys_getswitchinterval" => {
            Some(crate::molt_sys_getswitchinterval as *const () as usize as u64)
        }
        "molt_sys_setswitchinterval" => {
            Some(crate::molt_sys_setswitchinterval as *const () as usize as u64)
        }
        "molt_sys_get_int_max_str_digits" => {
            Some(crate::molt_sys_get_int_max_str_digits as *const () as usize as u64)
        }
        "molt_sys_set_int_max_str_digits" => {
            Some(crate::molt_sys_set_int_max_str_digits as *const () as usize as u64)
        }
        "molt_sys_call_tracing_validate" => {
            Some(crate::molt_sys_call_tracing_validate as *const () as usize as u64)
        }
        "molt_sys_addaudithook" => Some(crate::molt_sys_addaudithook as *const () as usize as u64),
        "molt_sys_audit_hook_count" => {
            Some(crate::molt_sys_audit_hook_count as *const () as usize as u64)
        }
        "molt_sys_audit_get_hooks" => {
            Some(crate::molt_sys_audit_get_hooks as *const () as usize as u64)
        }
        "molt_sys_exit" => Some(crate::molt_sys_exit as *const () as usize as u64),
        "molt_sys_displayhook_write" => {
            Some(crate::molt_sys_displayhook_write as *const () as usize as u64)
        }
        "molt_sys_excepthook_write" => {
            Some(crate::molt_sys_excepthook_write as *const () as usize as u64)
        }
...
fn resolve_typing_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_typing_get_origin" => {
            Some(crate::molt_typing_get_origin as *const () as usize as u64)
        }
