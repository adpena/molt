...
fn resolve_core_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_gpu_linear_contiguous" => Some(crate::molt_gpu_linear_contiguous as *const () as usize as u64),
        "molt_gpu_linear_split_last_dim_contiguous" => Some(crate::molt_gpu_linear_split_last_dim_contiguous as *const () as usize as u64),
        "molt_gpu_tensor__tensor_linear_split_last_dim" => Some(crate::molt_gpu_tensor__tensor_linear_split_last_dim as *const () as usize as u64),
        "molt_gpu_tensor__tensor_scaled_dot_product_attention" => Some(crate::molt_gpu_tensor__tensor_scaled_dot_product_attention as *const () as usize as u64),
        "molt_gpu_turboquant_attention_packed" => Some(crate::molt_gpu_turboquant_attention_packed as *const () as usize as u64),
        "molt_gpu_tensor__tensor_concat_first_dim" => Some(crate::molt_gpu_tensor__tensor_concat_first_dim as *const () as usize as u64),
        "molt_gpu_tensor__tensor_scatter_rows" => Some(crate::molt_gpu_tensor__tensor_scatter_rows as *const () as usize as u64),
        "molt_gpu_tensor__tensor_take_rows" => Some(crate::molt_gpu_tensor__tensor_take_rows as *const () as usize as u64),
        "molt_gpu_linear_squared_relu_gate_interleaved_contiguous" => Some(crate::molt_gpu_linear_squared_relu_gate_interleaved_contiguous as *const () as usize as u64),
        "molt_gpu_tensor_from_parts" => Some(crate::molt_gpu_tensor_from_parts as *const () as usize as u64),
        "molt_gpu_repeat_axis_contiguous" => Some(crate::molt_gpu_repeat_axis_contiguous as *const () as usize as u64),
        "molt_gpu_tensor_from_buffer" => Some(crate::molt_gpu_tensor_from_buffer as *const () as usize as u64),
        "molt_gpu_tensor__zeros" => Some(crate::molt_gpu_tensor__zeros as *const () as usize as u64),
        "molt_gpu_buffer_to_list" => Some(crate::molt_gpu_buffer_to_list as *const () as usize as u64),
        "molt_gpu_interop_decode_bf16_bytes_to_f32" => Some(crate::molt_gpu_interop_decode_bf16_bytes_to_f32 as *const () as usize as u64),
        "molt_gpu_interop_decode_f16_bytes_to_f32" => Some(crate::molt_gpu_interop_decode_f16_bytes_to_f32 as *const () as usize as u64),
        "molt_gpu_broadcast_binary_contiguous" => Some(crate::molt_gpu_broadcast_binary_contiguous as *const () as usize as u64),
        "molt_gpu_matmul_contiguous" => Some(crate::molt_gpu_matmul_contiguous as *const () as usize as u64),
        "molt_gpu_rope_apply_contiguous" => Some(crate::molt_gpu_rope_apply_contiguous as *const () as usize as u64),
        "molt_gpu_permute_contiguous" => Some(crate::molt_gpu_permute_contiguous as *const () as usize as u64),
        "molt_gpu_softmax_last_axis_contiguous" => Some(crate::molt_gpu_softmax_last_axis_contiguous as *const () as usize as u64),
        "molt_gpu_rms_norm_last_axis_contiguous" => Some(crate::molt_gpu_rms_norm_last_axis_contiguous as *const () as usize as u64),
        "molt_gpu_squared_relu_gate_interleaved_contiguous" => Some(crate::molt_gpu_squared_relu_gate_interleaved_contiguous as *const () as usize as u64),
        ...
        "molt_bootstrap_descriptor_types" => Some(crate::molt_bootstrap_descriptor_types as *const () as usize as u64),
