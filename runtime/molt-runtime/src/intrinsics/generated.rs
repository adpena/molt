...
pub(crate) const INTRINSICS: &[IntrinsicSpec] = &[
    ...
    IntrinsicSpec { name: "molt_gpu_tensor__tensor_attention_hybrid_mask", symbol: "molt_gpu_tensor__tensor_attention_hybrid_mask", arity: 3 },
...
fn resolve_core_symbol(symbol: &str) -> Option<u64> {
    match symbol {
        ...
        "molt_gpu_tensor__tensor_attention_hybrid_mask" => Some(crate::builtins::gpu::molt_gpu_tensor__tensor_attention_hybrid_mask as *const () as usize as u64),
        "molt_gpu_tensor__tensor_scaled_dot_product_attention" => Some(crate::builtins::gpu::molt_gpu_tensor__tensor_scaled_dot_product_attention as *const () as usize as u64),
