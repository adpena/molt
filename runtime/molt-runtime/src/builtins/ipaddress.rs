...
use crate::builtins::numbers::to_bigint;
...
fn parse_ipv4_from_bits(_py: &PyToken<'_>, addr_bits: u64) -> Result<Ipv4Addr, u64> {
...
fn parse_ipv6_from_bits(_py: &PyToken<'_>, addr_bits: u64) -> Result<Ipv6Addr, u64> {
    let obj = obj_from_bits(addr_bits);
    if let Some(s) = string_obj_to_owned(obj) {
        return s
            .parse::<Ipv6Addr>()
