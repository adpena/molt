...
pub(super) const SOCK_NONBLOCK_FLAG: i32 = libc::SOCK_NONBLOCK;
#[cfg(all(unix, not(any(target_os = "linux", target_os = "android"))))]
pub(super) const SOCK_NONBLOCK_FLAG: i32 = 0;
#[cfg(all(unix, any(target_os = "linux", target_os = "android")))]
pub(super) const SOCK_CLOEXEC_FLAG: i32 = libc::SOCK_CLOEXEC;
#[cfg(all(unix, not(any(target_os = "linux", target_os = "android"))))]
pub(super) const SOCK_CLOEXEC_FLAG: i32 = 0;
...
pub(super) static ERRNO_CONSTANTS_CACHE: AtomicU64 = AtomicU64::new(0);
pub(super) static SOCKET_CONSTANTS_CACHE: AtomicU64 = AtomicU64::new(0);
pub(super) static OS_NAME_CACHE: AtomicU64 = AtomicU64::new(0);
pub(super) static SYS_PLATFORM_CACHE: AtomicU64 = AtomicU64::new(0);
...
pub(super) fn trace_env_get() -> bool {
...
pub(super) fn process_env_state() -> &'static Mutex<BTreeMap<String, String>> {
    PROCESS_ENV_STATE.get_or_init(|| Mutex::new(collect_env_state()))
}

pub(super) fn locale_state() -> &'static Mutex<String> {
...
pub(super) fn uuid_node() -> Result<u64, String> {
...
pub(super) fn uuid_v4_bytes() -> Result<[u8; 16], String> {
    let mut bytes = uuid_random_bytes::<16>()?;
    uuid_apply_version_and_variant(&mut bytes, 4);
    Ok(bytes)
}

pub(super) fn uuid_v3_bytes(namespace: &[u8], name: &[u8]) -> [u8; 16] {
...
pub(super) fn uuid_v5_bytes(namespace: &[u8], name: &[u8]) -> [u8; 16] {
...
pub(super) fn os_name_str() -> &'static str {
