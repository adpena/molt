// === FILE: runtime/molt-runtime/src/builtins/unicodedata_mod.rs ===
//
...
use crate::{MoltObject, PyToken, alloc_string, int_bits_from_i64, obj_from_bits, raise_exception};
...
fn char_from_bits(_py: &PyToken<'_>, bits: u64) -> Result<char, u64> {
...
fn alloc_str(_py: &PyToken<'_>, s: &str) -> u64 {
...
pub extern "C" fn molt_unicodedata_name(ch_bits: u64, default_bits: u64) -> u64 {
    crate::with_gil_entry!(_py, {
        ...
        crate::inc_ref_bits(_py, default_bits);
        default_bits
    })
}
