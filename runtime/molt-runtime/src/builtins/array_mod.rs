...
impl ArrayHandle {
    ...
    fn len(&self) -> usize {
        self.data.len().checked_div(self.typecode.itemsize()).unwrap_or(0)
    }
...
fn typecode_from_obj(_py: &PyToken<'_>, typecode_bits: u64, argument_one: bool) -> Result<Typecode, u64> {
