...
use crate::{
    ...
    molt_contains, molt_dict_from_obj, molt_dict_get, molt_eq, molt_getattr_builtin, molt_index,
    molt_iter, molt_iter_next, molt_len, molt_object_setattr, molt_repr_from_obj,
...
fn builtin_func_bits(_py: &PyToken<'_>, slot: &AtomicU64, fn_ptr: u64, arity: u64) -> u64 {
    init_atomic_bits(_py, slot, || {
        ...
        {
            eprintln!("molt wasm builtin_func_bits:types fn=0x{fn_ptr:x} arity={arity}");
        }
