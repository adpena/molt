...
pub(crate) fn builtin_func_bits(_py: &PyToken<'_>, slot: &AtomicU64, fn_ptr: u64, arity: u64) -> u64 {
    builtin_func_bits_with_default(_py, slot, fn_ptr, arity, 0)
}

pub(crate) fn builtin_func_bits_with_default(_py: &PyToken<'_>,
    slot: &AtomicU64,
    fn_ptr: u64,
    arity: u64,
    default_kind: i64,
...
pub(crate) fn builtin_classmethod_bits(_py: &PyToken<'_>, slot: &AtomicU64, fn_ptr: u64, arity: u64) -> u64 {
    init_atomic_bits(_py, slot, || {
...
pub(crate) fn not_implemented_bits(_py: &PyToken<'_>) -> u64 {
    init_atomic_bits(_py, &runtime_state(_py).special_cache.molt_not_implemented, || {
        let total_size = std::mem::size_of::<MoltHeader>();
...
pub(crate) fn bytes_method_bits(_py: &PyToken<'_>, name: &str) -> Option<u64> {
    match name {
        ...
        "decode" => Some(builtin_func_bits(_py,
...
pub(crate) fn builtin_class_method_bits(_py: &PyToken<'_>, class_bits: u64, name: &str) -> Option<u64> {
    ...
    if name == "__class_getitem__" {
        ...
        {
            return Some(builtin_classmethod_bits(_py,
...
pub(crate) fn object_method_bits(_py: &PyToken<'_>, name: &str) -> Option<u64> {
    match name {
        "__getattribute__" => Some(builtin_func_bits(_py,
        ...
        "__setattr__" => Some(builtin_func_bits(_py,
            &runtime_state(_py).method_cache.object_setattr,
            fn_addr!(molt_object_setattr),
            3,
        )),
        "__delattr__" => Some(builtin_func_bits(_py,
        ...
        "__ne__" => Some(builtin_func_bits(_py,
