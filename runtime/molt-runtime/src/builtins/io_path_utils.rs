...
pub(crate) use molt_runtime_platform::path_text::{
    path_as_uri_text, path_basename_text, path_compare_text, path_dirname_text,
    path_expandvars_with_lookup, path_isabs_text, path_join_many_text, path_join_raw,
    path_join_text, path_name_text, path_normpath_text, path_parents_text, path_parts_text,
