...
pub(crate) const PYTHON_BUILTIN_FUNCTION_COUNT: usize = 44;
...
pub(crate) fn python_builtin_function_info(
    ...
    match python_name {
        ...
        "globals" => Some(PythonBuiltinFunctionInfo {
            index: 41,
            python_name: "globals",
        ...
        "locals" => Some(PythonBuiltinFunctionInfo {
            index: 42,
            python_name: "locals",
        ...
        "__import__" => Some(PythonBuiltinFunctionInfo {
            index: 43,
...
pub(crate) fn resolve_test_python_builtin_symbol(symbol: &str) -> Option<u64> {
    let target = match symbol {
        "molt_abs_builtin" => crate::molt_abs_builtin as *const (),
        "molt_aiter" => crate::molt_aiter as *const (),
        "molt_all_builtin" => crate::molt_all_builtin as *const (),
        "molt_anext_builtin" => crate::molt_anext_builtin as *const (),
        "molt_any_builtin" => crate::molt_any_builtin as *const (),
        "molt_ascii_from_obj" => crate::molt_ascii_from_obj as *const (),
        "molt_bin_builtin" => crate::molt_bin_builtin as *const (),
        "molt_callable_builtin" => crate::molt_callable_builtin as *const (),
        "molt_chr" => crate::molt_chr as *const (),
        "molt_compile_builtin" => crate::molt_compile_builtin as *const (),
        "molt_del_attr_name" => crate::molt_del_attr_name as *const (),
        "molt_dir_builtin" => crate::molt_dir_builtin as *const (),
        "molt_divmod_builtin" => crate::molt_divmod_builtin as *const (),
        "molt_enumerate_builtin" => crate::molt_enumerate_builtin as *const (),
        "molt_filter_builtin" => crate::molt_filter_builtin as *const (),
        "molt_format_builtin" => crate::molt_format_builtin as *const (),
        "molt_getattr_builtin" => crate::molt_getattr_builtin as *const (),
        "molt_globals_builtin" => crate::molt_globals_builtin as *const (),
        "molt_has_attr_name" => crate::molt_has_attr_name as *const (),
        "molt_hash_builtin" => crate::molt_hash_builtin as *const (),
        "molt_hex_builtin" => crate::molt_hex_builtin as *const (),
        "molt_id" => crate::molt_id as *const (),
        "molt_importlib_import_transaction" => crate::molt_importlib_import_transaction as *const (),
        "molt_isinstance" => crate::molt_isinstance as *const (),
        "molt_issubclass" => crate::molt_issubclass as *const (),
        "molt_iter_checked" => crate::molt_iter_checked as *const (),
        "molt_len" => crate::molt_len as *const (),
        "molt_locals_builtin" => crate::molt_locals_builtin as *const (),
        "molt_map_builtin" => crate::molt_map_builtin as *const (),
        "molt_max_builtin" => crate::molt_max_builtin as *const (),
        "molt_min_builtin" => crate::molt_min_builtin as *const (),
        "molt_next_builtin" => crate::molt_next_builtin as *const (),
        ...
        "molt_round_builtin" => crate::molt_round_builtin as *const (),
        "molt_set_attr_name" => crate::molt_set_attr_name as *const (),
        "molt_sorted_builtin" => crate::molt_sorted_builtin as *const (),
        "molt_sum_builtin" => crate::molt_sum_builtin as *const (),
        "molt_vars_builtin" => crate::molt_vars_builtin as *const (),
        "molt_zip_builtin" => crate::molt_zip_builtin as *const (),
        _ => return None,
    };
