...
#[inline]
fn unpack_i64(_py: &PyToken<'_>, bits: u64, label: &str) -> Result<i64, u64> {
...
#[inline]
fn unpack_f64(_py: &PyToken<'_>, bits: u64, label: &str) -> Result<f64, u64> {
    let obj = obj_from_bits(bits);
...
fn tuple_bits(_py: &PyToken<'_>, elems: &[u64]) -> u64 {
...
fn string_bits(_py: &PyToken<'_>, s: &str) -> u64 {
