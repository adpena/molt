...
pub extern "C" fn molt_tk_bind_callback_register(
    ...
    molt_runtime_tk::tk::molt_tk_bind_callback_register(
        app_bits,
        target_bits,
        sequence_bits,
        callback_bits,
...
pub extern "C" fn molt_tk_bind_callback_unregister(
    ...
    molt_runtime_tk::tk::molt_tk_bind_callback_unregister(
        app_bits,
        target_bits,
        sequence_bits,
        command_name_bits,
...
pub extern "C" fn molt_tk_widget_bind_callback_register(
    ...
    molt_runtime_tk::tk::molt_tk_widget_bind_callback_register(
        app_bits,
        widget_path_bits,
        bind_target_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_widget_bind_callback_unregister(
    ...
    molt_runtime_tk::tk::molt_tk_widget_bind_callback_unregister(
        app_bits,
        widget_path_bits,
        bind_target_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_text_tag_bind_callback_register(
    ...
    molt_runtime_tk::tk::molt_tk_text_tag_bind_callback_register(
        app_bits,
        widget_path_bits,
        tagname_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_text_tag_bind_callback_unregister(
    ...
    molt_runtime_tk::tk::molt_tk_text_tag_bind_callback_unregister(
        app_bits,
        widget_path_bits,
        tagname_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_treeview_tag_bind_callback_register(
    ...
    molt_runtime_tk::tk::molt_tk_treeview_tag_bind_callback_register(
        app_bits,
        widget_path_bits,
        tagname_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_treeview_tag_bind_callback_unregister(
    ...
    molt_runtime_tk::tk::molt_tk_treeview_tag_bind_callback_unregister(
        app_bits,
        widget_path_bits,
        tagname_bits,
        sequence_bits,
...
pub extern "C" fn molt_tk_filehandler_create(
    ...
    molt_runtime_tk::tk::molt_tk_filehandler_create(
        app_bits,
        fd_bits,
        mask_bits,
        callback_bits,
...
pub extern "C" fn molt_tk_dialog_show(
    ...
    molt_runtime_tk::tk::molt_tk_dialog_show(
        app_bits,
        master_path_bits,
        title_bits,
        text_bits,
...
pub extern "C" fn molt_tk_commondialog_show(
    ...
    molt_runtime_tk::tk::molt_tk_commondialog_show(
        app_bits,
        master_path_bits,
        command_bits,
        options_bits,
...
pub extern "C" fn molt_tk_filedialog_show(
    ...
    molt_runtime_tk::tk::molt_tk_filedialog_show(
        app_bits,
        master_path_bits,
        command_bits,
        options_bits,
...
pub extern "C" fn molt_tk_simpledialog_query(
    ...
    molt_runtime_tk::tk::molt_tk_simpledialog_query(
        app_bits,
        parent_path_bits,
        title_bits,
        prompt_bits,
