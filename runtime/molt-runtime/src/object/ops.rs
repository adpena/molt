...
pub(super) fn compare_type_error(_py: &PyToken<'_>, lhs: MoltObject, rhs: MoltObject, op: &str) -> u64 {
    let msg = format!(
...
#[derive(Clone, Copy)]
pub(super) enum CompareBoolOutcome {
    True,
    False,
    NotComparable,
    Error,
...
pub(super) fn compare_builtin_bool(
    _py: &PyToken<'_>,
    lhs: MoltObject,
    rhs: MoltObject,
    op: CompareOp,
...
pub(super) fn rich_compare_bool(
    _py: &PyToken<'_>,
    lhs: MoltObject,
    rhs: MoltObject,
    op_name_bits: u64,
