...
pub(crate) const TYPE_ID_ENUMERATE: u32 = 234;
pub(crate) const TYPE_ID_CALLARGS: u32 = 235;
pub(crate) const TYPE_ID_NOT_IMPLEMENTED: u32 = 236;
pub(crate) const TYPE_ID_CALL_ITER: u32 = 237;
pub(crate) const TYPE_ID_REVERSED: u32 = 238;
pub(crate) const TYPE_ID_ZIP: u32 = 239;
pub(crate) const TYPE_ID_MAP: u32 = 240;
pub(crate) const TYPE_ID_FILTER: u32 = 241;
pub(crate) const TYPE_ID_CODE: u32 = 242;
pub(crate) const TYPE_ID_ELLIPSIS: u32 = 243;
pub(crate) const TYPE_ID_GENERIC_ALIAS: u32 = 244;
pub(crate) const TYPE_ID_ASYNC_GENERATOR: u32 = 245;
