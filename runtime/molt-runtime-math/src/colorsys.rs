...
fn tuple3_bits(_py: &PyToken, a_bits: u64, b_bits: u64, c_bits: u64) -> u64 {
...
fn coerce_real_f64(_py: &PyToken, val_bits: u64) -> Option<f64> {
...
fn hsv_sector(_py: &PyToken, h: f64) -> Option<(i64, f64)> {
    let h6 = h * 6.0;
    if h6.is_nan() {
