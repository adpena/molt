...
/// Op kinds that need imports beyond their own name.
/// Key: op kind from IR. Value: list of import names needed.
/// Ops not listed here use auto-discovery: if op.kind matches an import name, include it.
