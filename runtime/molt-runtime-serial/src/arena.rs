//! Lightweight bump allocator for temporary scratch allocations during parsing.
//!
//! This is a standalone copy of `molt-runtime/src/arena.rs` so the serial crate
//! does not need to depend on runtime internals.
