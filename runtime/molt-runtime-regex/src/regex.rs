...
fn regex_state(_py: &CoreGilToken) -> &'static RegexRuntimeState {
...
fn re_alloc_handle(_py: &CoreGilToken) -> i64 {
    regex_state(_py).next_handle.fetch_add(1, Ordering::Relaxed)
}

fn re_store_pattern(_py: &CoreGilToken, handle: i64, pattern: CompiledPattern) {
