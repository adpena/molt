...
unsafe extern "C" {
    ...
    fn __molt_crypto_bytes_like_slice(ptr: *mut u8, out_ptr: *mut *const u8, out_len: *mut usize) -> i32;
    fn __molt_crypto_bytes_like_slice_raw(ptr: *mut u8, out_ptr: *mut *const u8, out_len: *mut usize) -> i32;
    fn __molt_crypto_string_obj_to_owned(bits: u64, out_ptr: *mut *const u8, out_len: *mut usize) -> i32;
...
unsafe extern "C" {
    ...
    fn __molt_crypto_int_bits_from_bigint(
        sign: i32,
        data_ptr: *const u8,
        data_len: usize,
    ) -> u64;
    fn __molt_crypto_index_i64_from_obj(
        obj_bits: u64,
        err_ptr: *const u8,
        err_len: usize,
    ) -> i64;
