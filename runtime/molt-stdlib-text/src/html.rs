...
fn alloc_str_or_err(_py: &CoreGilToken, s: &str) -> Result<u64, u64> {
...
fn alloc_tuple2(_py: &CoreGilToken, a: u64, b: u64) -> Result<u64, u64> {
...
fn alloc_tuple3(_py: &CoreGilToken, a: u64, b: u64, c: u64) -> Result<u64, u64> {
...
fn attrs_to_list(_py: &CoreGilToken, attrs: &[(String, Option<String>)]) -> Result<u64, u64> {
...
fn event_to_bits(_py: &CoreGilToken, ev: HtmlEvent) -> Result<u64, u64> {
    match ev {
...
fn events_to_list(_py: &CoreGilToken, events: Vec<HtmlEvent>) -> u64 {
