...
/// Scalar add/sub/mul kind authority for [`handle_arith_op`]. The delegated
...
/// Cranelift codegen dispatcher for scalar add/sub/mul arithmetic ops.
...
/// changed.
///
/// Each `match` arm delegates to a per-family free `fn` that carries that arm's
/// body VERBATIM — the same move-only idiom that split `handle_call_op`
/// (`fc::calls`). The dispatcher owns only the kind routing; the emitted
/// Cranelift IR (and thus the object bytes) is byte-identical to the
/// pre-split monolith (proved by `arith_op_family_split_is_byte_identical`).
#[cfg(feature = "native-backend")]
...
pub(in crate::native_backend::function_compiler) fn handle_arith_op(
    ...
    match op.kind.as_str() {
        ...
        "checked_add" => handle_checked_add_op(
            op,
            &mut *module,
            &mut *import_ids,
            &mut *builder,
        ...
        "checked_mul" => handle_checked_mul_op(
            op,
            &mut *module,
            &mut *import_ids,
            &mut *builder,
        ...
        "inplace_add" => handle_inplace_add_op(
            op,
            &mut *module,
            &mut *import_ids,
            &mut *builder,
        ...
        "inplace_sub" => handle_inplace_sub_op(
            op,
            op_idx,
            func_name,
            &mut *module,
        ...
        "inplace_mul" => handle_inplace_mul_op(
            op,
            &mut *module,
            &mut *import_ids,
            &mut *builder,
...
/// `add` arm of [`handle_arith_op`], body moved verbatim.
fn handle_add_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `checked_add` arm of [`handle_arith_op`], body moved verbatim.
fn handle_checked_add_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
    builder: &mut FunctionBuilder<'_>,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `checked_mul` arm of [`handle_arith_op`], body moved verbatim.
fn handle_checked_mul_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
    builder: &mut FunctionBuilder<'_>,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `inplace_add` arm of [`handle_arith_op`], body moved verbatim.
fn handle_inplace_add_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
    builder: &mut FunctionBuilder<'_>,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `sub` arm of [`handle_arith_op`], body moved verbatim.
fn handle_sub_op(
    op: &OpIR,
    op_idx: usize,
    func_name: &str,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `inplace_sub` arm of [`handle_arith_op`], body moved verbatim.
fn handle_inplace_sub_op(
    op: &OpIR,
    op_idx: usize,
    func_name: &str,
    module: &mut ObjectModule,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `mul` arm of [`handle_arith_op`], body moved verbatim.
fn handle_mul_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
...
#[cfg(feature = "native-backend")]
#[allow(clippy::too_many_arguments, clippy::manual_map)]
/// `inplace_mul` arm of [`handle_arith_op`], body moved verbatim.
fn handle_inplace_mul_op(
    op: &OpIR,
    module: &mut ObjectModule,
    import_ids: &mut BTreeMap<&'static str, (cranelift_module::FuncId, ImportSignatureShape)>,
    builder: &mut FunctionBuilder<'_>,
