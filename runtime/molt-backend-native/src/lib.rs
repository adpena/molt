...
pub(crate) use molt_codegen_abi::{
    ...
    GENERATOR_CONTROL_BYTES, HEADER_AUX_KIND_CLASS_INLINE, HEADER_AUX_KIND_OFFSET,
    HEADER_AUX_OFFSET, HEADER_CLASS_WORD_BORROWED, HEADER_FLAG_CONTAINS_REFS, HEADER_FLAG_HAS_PTRS,
