...
pub fn kind_to_opcode_table(kind: &str) -> Option<OpCode> {
    match kind {
        ...
        "call_method_ic" => Some(OpCode::CallMethodIc),
        "call_super_method_ic" => Some(OpCode::CallSuperMethodIc),
...
pub fn opcode_ssa_s_value_attr_key_table(opcode: OpCode) -> Option<&'static str> {
    match opcode {
        ...
        OpCode::CallMethodIc => Some("method"),
        OpCode::CallSuperMethodIc => Some("method"),
...
pub fn opcode_effects_table(opcode: OpCode) -> OpcodeEffects {
    let mut effects = match opcode {
        ...
        OpCode::Le => OPCODE_EFFECTS_IMPURE,
        OpCode::Gt => OPCODE_EFFECTS_IMPURE,
        OpCode::Ge => OPCODE_EFFECTS_IMPURE,
        ...
        OpCode::CallMethodIc => OPCODE_EFFECTS_IMPURE,
        OpCode::CallSuperMethodIc => OPCODE_EFFECTS_IMPURE,
        OpCode::CallBuiltin => OPCODE_EFFECTS_IMPURE,
        OpCode::OrdAt => OPCODE_EFFECTS_IMPURE,
        OpCode::BoxVal => OPCODE_EFFECTS_PURE_MAY_THROW,
        ...
        OpCode::ConstBigInt => OPCODE_EFFECTS_PURE_MAY_THROW,
        OpCode::ConstFloat => OPCODE_EFFECTS_PURE,
        OpCode::ConstStr => OPCODE_EFFECTS_PURE_MAY_THROW,
        OpCode::ConstBool => OPCODE_EFFECTS_PURE,
        OpCode::ConstNone => OPCODE_EFFECTS_PURE,
        OpCode::ConstBytes => OPCODE_EFFECTS_PURE_MAY_THROW,
...
pub fn opcode_fuzz_tir_attr_payload_rule_table(opcode: OpCode) -> FuzzTirAttrPayloadRule {
    match opcode {
        ...
        OpCode::CallMethodIc => FuzzTirAttrPayloadRule::None,
        OpCode::CallSuperMethodIc => FuzzTirAttrPayloadRule::None,
...
pub fn opcode_predicate_semantics(opcode: OpCode) -> Option<PredicateSemantics> {
    match opcode {
        ...
        OpCode::Neg => None,
        OpCode::Pos => None,
        OpCode::Eq => Some(PredicateSemantics::Equality),
        OpCode::Ne => Some(PredicateSemantics::Equality),
        OpCode::Lt => Some(PredicateSemantics::Ordering),
        OpCode::Le => Some(PredicateSemantics::Ordering),
        OpCode::Gt => Some(PredicateSemantics::Ordering),
        OpCode::Ge => Some(PredicateSemantics::Ordering),
        OpCode::Is => None,
        OpCode::IsNot => None,
        OpCode::In => Some(PredicateSemantics::Containment),
        OpCode::NotIn => Some(PredicateSemantics::Containment),
        OpCode::BitAnd => None,
        OpCode::BitOr => None,
        OpCode::BitXor => None,
        OpCode::BitNot => None,
        ...
        OpCode::And => None,
        OpCode::Or => None,
        OpCode::Not => Some(PredicateSemantics::Truth),
        OpCode::Bool => Some(PredicateSemantics::Truth),
        OpCode::Alloc => None,
        OpCode::StackAlloc => None,
        OpCode::ObjectNewBound => None,
        OpCode::Free => None,
...
pub fn opcode_exact_scalar_result_tir_type(
    opcode: OpCode,
    result_index: usize,
) -> Option<crate::tir::types::TirType> {
    match (opcode, result_index) {
...
pub fn opcode_operand_independent_result_type_table(
    ...
    let results: &[Option<OperandIndependentResultType>] = match opcode {
        ...
        OpCode::Mul => &[],
        OpCode::CheckedAdd => &[
            Some(OperandIndependentResultType::I64),
            Some(OperandIndependentResultType::Bool),
        ],
        OpCode::CheckedMul => &[
            Some(OperandIndependentResultType::I64),
            Some(OperandIndependentResultType::Bool),
        ...
        OpCode::FloorDiv => &[],
        OpCode::Mod => &[],
        OpCode::Pow => &[Some(OperandIndependentResultType::DynBox)],
        OpCode::Neg => &[],
        OpCode::Pos => &[],
        OpCode::Eq => &[],
        OpCode::Ne => &[],
        ...
        OpCode::GetIter => &[],
        OpCode::IterNext => &[],
        OpCode::IterNextUnboxed => &[None, Some(OperandIndependentResultType::Bool)],
        OpCode::UnpackSequence => &[],
        OpCode::ForIter => &[],
        OpCode::AllocTask => &[],
        OpCode::StateSwitch => &[],
        ...
        OpCode::Raise => &[],
        OpCode::CheckException => &[],
        OpCode::ExceptionPending => &[Some(OperandIndependentResultType::Bool)],
        OpCode::FunctionDefaultsVersion => &[],
        OpCode::TryStart => &[],
        OpCode::TryEnd => &[],
        OpCode::StateBlockStart => &[],
...
pub fn opcode_type_refine_operand_type_rule_table(opcode: OpCode) -> TypeRefineOperandTypeRule {
    match opcode {
        ...
        OpCode::CallMethodIc => TypeRefineOperandTypeRule::None,
        OpCode::CallSuperMethodIc => TypeRefineOperandTypeRule::None,
...
pub fn opcode_sccp_constant_seed_rule_table(opcode: OpCode) -> SccpConstantSeedRule {
    match opcode {
        ...
        OpCode::CallMethodIc => SccpConstantSeedRule::None,
        OpCode::CallSuperMethodIc => SccpConstantSeedRule::None,
...
pub fn opcode_sccp_constant_eval_rule_table(opcode: OpCode) -> SccpConstantEvalRule {
    match opcode {
        ...
        OpCode::CallMethodIc => SccpConstantEvalRule::None,
        OpCode::CallSuperMethodIc => SccpConstantEvalRule::None,
...
pub fn opcode_value_range_transfer_rule_table(opcode: OpCode) -> ValueRangeTransferRule {
    match opcode {
        ...
        OpCode::FloorDiv => ValueRangeTransferRule::FloorDiv,
        ...
        OpCode::CallMethodIc => ValueRangeTransferRule::None,
        OpCode::CallSuperMethodIc => ValueRangeTransferRule::None,
...
pub fn opcode_value_range_const_fold_rule_table(opcode: OpCode) -> ValueRangeConstFoldRule {
    match opcode {
        ...
        OpCode::CallMethodIc => ValueRangeConstFoldRule::None,
        OpCode::CallSuperMethodIc => ValueRangeConstFoldRule::None,
...
pub fn opcode_value_range_cond_narrow_rule_table(opcode: OpCode) -> ValueRangeCondNarrowRule {
    match opcode {
        ...
        OpCode::CallMethodIc => ValueRangeCondNarrowRule::None,
        OpCode::CallSuperMethodIc => ValueRangeCondNarrowRule::None,
...
pub fn opcode_range_devirt_role_table(opcode: OpCode) -> RangeDevirtRole {
    match opcode {
        ...
        OpCode::CallMethodIc => RangeDevirtRole::None,
        OpCode::CallSuperMethodIc => RangeDevirtRole::None,
...
pub fn opcode_vectorize_facts_table(opcode: OpCode) -> VectorizeOpcodeFacts {
    match opcode {
        ...
        OpCode::CallMethodIc => VectorizeOpcodeFacts {
            body_action: VectorizeBodyAction::Reject,
            reduction_rule: VectorReductionRule::None,
            annotation_target: false,
        },
        OpCode::CallSuperMethodIc => VectorizeOpcodeFacts {
            body_action: VectorizeBodyAction::Reject,
            reduction_rule: VectorReductionRule::None,
            annotation_target: false,
        },
...
pub fn opcode_repr_raw_i64_full_deopt_seed_rule_table(
    ...
    match opcode {
        ...
        OpCode::CallMethodIc => ReprRawI64FullDeoptSeedRule::None,
        OpCode::CallSuperMethodIc => ReprRawI64FullDeoptSeedRule::None,
...
pub fn opcode_repr_projectable_bool_result_rule_table(
    ...
    match opcode {
        ...
        OpCode::Eq => ReprProjectableBoolResultRule::ComparisonOperands,
        OpCode::Ne => ReprProjectableBoolResultRule::ComparisonOperands,
        OpCode::Lt => ReprProjectableBoolResultRule::ComparisonOperands,
        OpCode::Le => ReprProjectableBoolResultRule::ComparisonOperands,
        OpCode::Gt => ReprProjectableBoolResultRule::ComparisonOperands,
        OpCode::Ge => ReprProjectableBoolResultRule::ComparisonOperands,
        ...
        OpCode::CallMethodIc => ReprProjectableBoolResultRule::None,
        OpCode::CallSuperMethodIc => ReprProjectableBoolResultRule::None,
...
pub fn opcode_repr_projectable_float_result_rule_table(
    ...
    match opcode {
        ...
        OpCode::CallMethodIc => ReprProjectableFloatResultRule::None,
        OpCode::CallSuperMethodIc => ReprProjectableFloatResultRule::None,
...
pub fn opcode_counted_loop_comparison_role_table(opcode: OpCode) -> CountedLoopComparisonRole {
    match opcode {
        ...
        OpCode::CallMethodIc => CountedLoopComparisonRole::None,
        OpCode::CallSuperMethodIc => CountedLoopComparisonRole::None,
...
pub fn opcode_gvn_numbering_role_table(opcode: OpCode) -> GvnNumberingRole {
    match opcode {
        ...
        OpCode::CallMethodIc => GvnNumberingRole::Never,
        OpCode::CallSuperMethodIc => GvnNumberingRole::Never,
        OpCode::CallBuiltin => GvnNumberingRole::Never,
        OpCode::OrdAt => GvnNumberingRole::Never,
        OpCode::BoxVal => GvnNumberingRole::Never,
...
pub fn opcode_refcount_balance_role_table(opcode: OpCode) -> RefcountBalanceRole {
    match opcode {
        ...
        OpCode::CallMethodIc => RefcountBalanceRole::NotRefcountBalance,
        OpCode::CallSuperMethodIc => RefcountBalanceRole::NotRefcountBalance,
...
pub fn opcode_generator_fusion_poll_role_table(opcode: OpCode) -> GeneratorFusionPollRole {
    match opcode {
        ...
        OpCode::CallMethodIc => GeneratorFusionPollRole::Neutral,
        OpCode::CallSuperMethodIc => GeneratorFusionPollRole::Neutral,
...
pub fn opcode_generator_fusion_iter_use_role_table(opcode: OpCode) -> GeneratorFusionIterUseRole {
    match opcode {
        ...
        OpCode::CallMethodIc => GeneratorFusionIterUseRole::None,
        OpCode::CallSuperMethodIc => GeneratorFusionIterUseRole::None,
...
pub fn opcode_module_concurrency_marker_source_facts_table(
    ...
    match opcode {
        ...
        OpCode::CallMethodIc => MODULE_CONCURRENCY_MARKER_SOURCE_NONE,
        OpCode::CallSuperMethodIc => MODULE_CONCURRENCY_MARKER_SOURCE_NONE,
...
pub fn opcode_module_slot_access_role_table(opcode: OpCode) -> ModuleSlotAccessRole {
    match opcode {
        ...
        OpCode::CallMethodIc => ModuleSlotAccessRole::None,
        OpCode::CallSuperMethodIc => ModuleSlotAccessRole::None,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BoxedAllocationLayoutRule {
    None,
    ClassMissing,
    RawZeroed,
}

/// BoxedAllocationLayoutRule by opcode. EXHAUSTIVE over OpCode so a new opcode
/// cannot silently enter or miss this consumer through pass-local
/// wildcard/default logic.
#[inline]
pub fn opcode_boxed_allocation_layout_rule_table(opcode: OpCode) -> BoxedAllocationLayoutRule {
    match opcode {
        OpCode::Add => BoxedAllocationLayoutRule::None,
        OpCode::Sub => BoxedAllocationLayoutRule::None,
        OpCode::Mul => BoxedAllocationLayoutRule::None,
        OpCode::CheckedAdd => BoxedAllocationLayoutRule::None,
        OpCode::CheckedMul => BoxedAllocationLayoutRule::None,
        OpCode::InplaceAdd => BoxedAllocationLayoutRule::None,
        OpCode::InplaceSub => BoxedAllocationLayoutRule::None,
        OpCode::InplaceMul => BoxedAllocationLayoutRule::None,
        OpCode::Div => BoxedAllocationLayoutRule::None,
        OpCode::FloorDiv => BoxedAllocationLayoutRule::None,
        OpCode::Mod => BoxedAllocationLayoutRule::None,
        OpCode::Pow => BoxedAllocationLayoutRule::None,
        OpCode::Neg => BoxedAllocationLayoutRule::None,
        OpCode::Pos => BoxedAllocationLayoutRule::None,
        OpCode::Eq => BoxedAllocationLayoutRule::None,
        OpCode::Ne => BoxedAllocationLayoutRule::None,
        OpCode::Lt => BoxedAllocationLayoutRule::None,
        OpCode::Le => BoxedAllocationLayoutRule::None,
        OpCode::Gt => BoxedAllocationLayoutRule::None,
        OpCode::Ge => BoxedAllocationLayoutRule::None,
        OpCode::Is => BoxedAllocationLayoutRule::None,
        OpCode::IsNot => BoxedAllocationLayoutRule::None,
        OpCode::In => BoxedAllocationLayoutRule::None,
        OpCode::NotIn => BoxedAllocationLayoutRule::None,
        OpCode::BitAnd => BoxedAllocationLayoutRule::None,
        OpCode::BitOr => BoxedAllocationLayoutRule::None,
        OpCode::BitXor => BoxedAllocationLayoutRule::None,
        OpCode::BitNot => BoxedAllocationLayoutRule::None,
        OpCode::Shl => BoxedAllocationLayoutRule::None,
        OpCode::Shr => BoxedAllocationLayoutRule::None,
        OpCode::And => BoxedAllocationLayoutRule::None,
        OpCode::Or => BoxedAllocationLayoutRule::None,
        OpCode::Not => BoxedAllocationLayoutRule::None,
        OpCode::Bool => BoxedAllocationLayoutRule::None,
        OpCode::Alloc => BoxedAllocationLayoutRule::RawZeroed,
        OpCode::StackAlloc => BoxedAllocationLayoutRule::None,
        OpCode::ObjectNewBound => BoxedAllocationLayoutRule::ClassMissing,
        OpCode::Free => BoxedAllocationLayoutRule::None,
        OpCode::LoadAttr => BoxedAllocationLayoutRule::None,
        OpCode::StoreAttr => BoxedAllocationLayoutRule::None,
        OpCode::DelAttr => BoxedAllocationLayoutRule::None,
        OpCode::Index => BoxedAllocationLayoutRule::None,
        OpCode::StoreIndex => BoxedAllocationLayoutRule::None,
        OpCode::DelIndex => BoxedAllocationLayoutRule::None,
        OpCode::DeleteVar => BoxedAllocationLayoutRule::None,
        OpCode::Call => BoxedAllocationLayoutRule::None,
        OpCode::CallMethod => BoxedAllocationLayoutRule::None,
        OpCode::CallMethodIc => BoxedAllocationLayoutRule::None,
        OpCode::CallSuperMethodIc => BoxedAllocationLayoutRule::None,
        OpCode::CallBuiltin => BoxedAllocationLayoutRule::None,
        OpCode::OrdAt => BoxedAllocationLayoutRule::None,
        OpCode::BoxVal => BoxedAllocationLayoutRule::None,
        OpCode::UnboxVal => BoxedAllocationLayoutRule::None,
        OpCode::TypeGuard => BoxedAllocationLayoutRule::None,
        OpCode::IncRef => BoxedAllocationLayoutRule::None,
        OpCode::DecRef => BoxedAllocationLayoutRule::None,
        OpCode::DelBoundary => BoxedAllocationLayoutRule::None,
        OpCode::BuildList => BoxedAllocationLayoutRule::None,
        OpCode::BuildDict => BoxedAllocationLayoutRule::None,
        OpCode::BuildTuple => BoxedAllocationLayoutRule::None,
        OpCode::BuildSet => BoxedAllocationLayoutRule::None,
        OpCode::BuildSlice => BoxedAllocationLayoutRule::None,
        OpCode::GetIter => BoxedAllocationLayoutRule::None,
        OpCode::IterNext => BoxedAllocationLayoutRule::None,
        OpCode::IterNextUnboxed => BoxedAllocationLayoutRule::None,
        OpCode::UnpackSequence => BoxedAllocationLayoutRule::None,
        OpCode::ForIter => BoxedAllocationLayoutRule::None,
        ...
        OpCode::Raise => BoxedAllocationLayoutRule::None,
        OpCode::CheckException => BoxedAllocationLayoutRule::None,
        OpCode::ExceptionPending => BoxedAllocationLayoutRule::None,
        OpCode::FunctionDefaultsVersion => BoxedAllocationLayoutRule::None,
        OpCode::TryStart => BoxedAllocationLayoutRule::None,
        OpCode::TryEnd => BoxedAllocationLayoutRule::None,
        OpCode::StateBlockStart => BoxedAllocationLayoutRule::None,
        OpCode::StateBlockEnd => BoxedAllocationLayoutRule::None,
        OpCode::ConstInt => BoxedAllocationLayoutRule::None,
        OpCode::ConstBigInt => BoxedAllocationLayoutRule::None,
        OpCode::ConstFloat => BoxedAllocationLayoutRule::None,
        OpCode::ConstStr => BoxedAllocationLayoutRule::None,
        OpCode::ConstBool => BoxedAllocationLayoutRule::None,
        OpCode::ConstNone => BoxedAllocationLayoutRule::None,
        OpCode::ConstBytes => BoxedAllocationLayoutRule::None,
        OpCode::Copy => BoxedAllocationLayoutRule::None,
        OpCode::Import => BoxedAllocationLayoutRule::None,
        OpCode::ImportFrom => BoxedAllocationLayoutRule::None,
        OpCode::ModuleCacheGet => BoxedAllocationLayoutRule::None,
        OpCode::ModuleCacheSet => BoxedAllocationLayoutRule::None,
        OpCode::ModuleCacheDel => BoxedAllocationLayoutRule::None,
        OpCode::ModuleGetAttr => BoxedAllocationLayoutRule::None,
        OpCode::ModuleImportFrom => BoxedAllocationLayoutRule::None,
        OpCode::ModuleGetGlobal => BoxedAllocationLayoutRule::None,
        OpCode::ModuleGetName => BoxedAllocationLayoutRule::None,
        OpCode::ModuleSetAttr => BoxedAllocationLayoutRule::None,
        OpCode::ModuleDelGlobal => BoxedAllocationLayoutRule::None,
        OpCode::ModuleDelGlobalIfPresent => BoxedAllocationLayoutRule::None,
        OpCode::WarnStderr => BoxedAllocationLayoutRule::None,
        OpCode::ScfIf => BoxedAllocationLayoutRule::None,
        OpCode::ScfFor => BoxedAllocationLayoutRule::None,
        OpCode::ScfWhile => BoxedAllocationLayoutRule::None,
        OpCode::ScfYield => BoxedAllocationLayoutRule::None,
    }
}
...
/// wildcard/default logic.
#[inline]
pub fn opcode_tir_verify_attr_rule_table(opcode: OpCode) -> TirVerifyAttrRule {
    match opcode {
        OpCode::Add => TirVerifyAttrRule::None,
        OpCode::Sub => TirVerifyAttrRule::None,
        OpCode::Mul => TirVerifyAttrRule::None,
        OpCode::CheckedAdd => TirVerifyAttrRule::None,
        OpCode::CheckedMul => TirVerifyAttrRule::None,
        OpCode::InplaceAdd => TirVerifyAttrRule::None,
        OpCode::InplaceSub => TirVerifyAttrRule::None,
        OpCode::InplaceMul => TirVerifyAttrRule::None,
        OpCode::Div => TirVerifyAttrRule::None,
        OpCode::FloorDiv => TirVerifyAttrRule::None,
        OpCode::Mod => TirVerifyAttrRule::None,
        OpCode::Pow => TirVerifyAttrRule::None,
        OpCode::Neg => TirVerifyAttrRule::None,
        OpCode::Pos => TirVerifyAttrRule::None,
        OpCode::Eq => TirVerifyAttrRule::None,
        OpCode::Ne => TirVerifyAttrRule::None,
        OpCode::Lt => TirVerifyAttrRule::None,
        OpCode::Le => TirVerifyAttrRule::None,
        OpCode::Gt => TirVerifyAttrRule::None,
        OpCode::Ge => TirVerifyAttrRule::None,
        OpCode::Is => TirVerifyAttrRule::None,
        OpCode::IsNot => TirVerifyAttrRule::None,
        OpCode::In => TirVerifyAttrRule::None,
        OpCode::NotIn => TirVerifyAttrRule::None,
        OpCode::BitAnd => TirVerifyAttrRule::None,
        OpCode::BitOr => TirVerifyAttrRule::None,
        OpCode::BitXor => TirVerifyAttrRule::None,
        OpCode::BitNot => TirVerifyAttrRule::None,
        OpCode::Shl => TirVerifyAttrRule::None,
        OpCode::Shr => TirVerifyAttrRule::None,
        OpCode::And => TirVerifyAttrRule::None,
        OpCode::Or => TirVerifyAttrRule::None,
        OpCode::Not => TirVerifyAttrRule::None,
        OpCode::Bool => TirVerifyAttrRule::None,
        ...
        OpCode::DelAttr => TirVerifyAttrRule::None,
        OpCode::Index => TirVerifyAttrRule::None,
        OpCode::StoreIndex => TirVerifyAttrRule::None,
        OpCode::DelIndex => TirVerifyAttrRule::None,
        OpCode::DeleteVar => TirVerifyAttrRule::None,
        OpCode::Call => TirVerifyAttrRule::CallCallee,
        OpCode::CallMethod => TirVerifyAttrRule::CallMethod,
        OpCode::CallMethodIc => TirVerifyAttrRule::CallMethod,
        OpCode::CallSuperMethodIc => TirVerifyAttrRule::CallMethod,
        OpCode::CallBuiltin => TirVerifyAttrRule::CallCallee,
        OpCode::OrdAt => TirVerifyAttrRule::None,
        OpCode::BoxVal => TirVerifyAttrRule::None,
        OpCode::UnboxVal => TirVerifyAttrRule::None,
        OpCode::TypeGuard => TirVerifyAttrRule::None,
        OpCode::IncRef => TirVerifyAttrRule::None,
        OpCode::DecRef => TirVerifyAttrRule::None,
        OpCode::DelBoundary => TirVerifyAttrRule::None,
        OpCode::BuildList => TirVerifyAttrRule::None,
        OpCode::BuildDict => TirVerifyAttrRule::None,
        OpCode::BuildTuple => TirVerifyAttrRule::None,
        OpCode::BuildSet => TirVerifyAttrRule::None,
        OpCode::BuildSlice => TirVerifyAttrRule::None,
        ...
        OpCode::Raise => TirVerifyAttrRule::None,
        OpCode::CheckException => TirVerifyAttrRule::None,
        OpCode::ExceptionPending => TirVerifyAttrRule::None,
        OpCode::FunctionDefaultsVersion => TirVerifyAttrRule::None,
        OpCode::TryStart => TirVerifyAttrRule::None,
        OpCode::TryEnd => TirVerifyAttrRule::None,
        OpCode::StateBlockStart => TirVerifyAttrRule::None,
        OpCode::StateBlockEnd => TirVerifyAttrRule::None,
        OpCode::ConstInt => TirVerifyAttrRule::None,
        OpCode::ConstBigInt => TirVerifyAttrRule::None,
        OpCode::ConstFloat => TirVerifyAttrRule::None,
        OpCode::ConstStr => TirVerifyAttrRule::None,
        OpCode::ConstBool => TirVerifyAttrRule::None,
        OpCode::ConstNone => TirVerifyAttrRule::None,
        OpCode::ConstBytes => TirVerifyAttrRule::None,
        OpCode::Copy => TirVerifyAttrRule::None,
        OpCode::Import => TirVerifyAttrRule::None,
        OpCode::ImportFrom => TirVerifyAttrRule::None,
        OpCode::ModuleCacheGet => TirVerifyAttrRule::None,
        OpCode::ModuleCacheSet => TirVerifyAttrRule::None,
        OpCode::ModuleCacheDel => TirVerifyAttrRule::None,
        OpCode::ModuleGetAttr => TirVerifyAttrRule::None,
        OpCode::ModuleImportFrom => TirVerifyAttrRule::None,
        OpCode::ModuleGetGlobal => TirVerifyAttrRule::None,
        OpCode::ModuleGetName => TirVerifyAttrRule::None,
        OpCode::ModuleSetAttr => TirVerifyAttrRule::None,
        OpCode::ModuleDelGlobal => TirVerifyAttrRule::None,
        OpCode::ModuleDelGlobalIfPresent => TirVerifyAttrRule::None,
        OpCode::WarnStderr => TirVerifyAttrRule::None,
        OpCode::ScfIf => TirVerifyAttrRule::None,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum StrengthReductionRule {
    None,
    MulByTwo,
    PowSquare,
    PowerTwoFloorDiv,
...
/// StrengthReductionRule by opcode. EXHAUSTIVE over OpCode so a new opcode
/// cannot silently enter or miss this consumer through pass-local
/// wildcard/default logic.
#[inline]
pub fn opcode_strength_reduction_rule_table(opcode: OpCode) -> StrengthReductionRule {
    match opcode {
        OpCode::Add => StrengthReductionRule::None,
        OpCode::Sub => StrengthReductionRule::None,
        OpCode::Mul => StrengthReductionRule::MulByTwo,
        OpCode::CheckedAdd => StrengthReductionRule::None,
        OpCode::CheckedMul => StrengthReductionRule::None,
        OpCode::InplaceAdd => StrengthReductionRule::None,
        OpCode::InplaceSub => StrengthReductionRule::None,
        OpCode::InplaceMul => StrengthReductionRule::None,
        OpCode::Div => StrengthReductionRule::None,
        OpCode::FloorDiv => StrengthReductionRule::PowerTwoFloorDiv,
        OpCode::Mod => StrengthReductionRule::PowerTwoMod,
        OpCode::Pow => StrengthReductionRule::PowSquare,
        OpCode::Neg => StrengthReductionRule::None,
        OpCode::Pos => StrengthReductionRule::None,
        OpCode::Eq => StrengthReductionRule::None,
        OpCode::Ne => StrengthReductionRule::None,
        OpCode::Lt => StrengthReductionRule::None,
        OpCode::Le => StrengthReductionRule::None,
        OpCode::Gt => StrengthReductionRule::None,
        OpCode::Ge => StrengthReductionRule::None,
        OpCode::Is => StrengthReductionRule::None,
        OpCode::IsNot => StrengthReductionRule::None,
        OpCode::In => StrengthReductionRule::None,
        OpCode::NotIn => StrengthReductionRule::None,
        OpCode::BitAnd => StrengthReductionRule::None,
        OpCode::BitOr => StrengthReductionRule::None,
        OpCode::BitXor => StrengthReductionRule::None,
        OpCode::BitNot => StrengthReductionRule::None,
        OpCode::Shl => StrengthReductionRule::None,
        OpCode::Shr => StrengthReductionRule::None,
        OpCode::And => StrengthReductionRule::None,
        OpCode::Or => StrengthReductionRule::None,
        OpCode::Not => StrengthReductionRule::None,
        OpCode::Bool => StrengthReductionRule::None,
        ...
        OpCode::DelAttr => StrengthReductionRule::None,
        OpCode::Index => StrengthReductionRule::None,
        OpCode::StoreIndex => StrengthReductionRule::None,
        OpCode::DelIndex => StrengthReductionRule::None,
        OpCode::DeleteVar => StrengthReductionRule::None,
        OpCode::Call => StrengthReductionRule::None,
        OpCode::CallMethod => StrengthReductionRule::None,
        OpCode::CallMethodIc => StrengthReductionRule::None,
        OpCode::CallSuperMethodIc => StrengthReductionRule::None,
        OpCode::CallBuiltin => StrengthReductionRule::None,
        OpCode::OrdAt => StrengthReductionRule::None,
        OpCode::BoxVal => StrengthReductionRule::None,
        OpCode::UnboxVal => StrengthReductionRule::None,
        OpCode::TypeGuard => StrengthReductionRule::None,
        OpCode::IncRef => StrengthReductionRule::None,
        OpCode::DecRef => StrengthReductionRule::None,
        OpCode::DelBoundary => StrengthReductionRule::None,
        OpCode::BuildList => StrengthReductionRule::None,
        OpCode::BuildDict => StrengthReductionRule::None,
        OpCode::BuildTuple => StrengthReductionRule::None,
        OpCode::BuildSet => StrengthReductionRule::None,
        OpCode::BuildSlice => StrengthReductionRule::None,
        ...
        OpCode::Raise => StrengthReductionRule::None,
        OpCode::CheckException => StrengthReductionRule::None,
        OpCode::ExceptionPending => StrengthReductionRule::None,
        OpCode::FunctionDefaultsVersion => StrengthReductionRule::None,
        OpCode::TryStart => StrengthReductionRule::None,
        OpCode::TryEnd => StrengthReductionRule::None,
        OpCode::StateBlockStart => StrengthReductionRule::None,
        OpCode::StateBlockEnd => StrengthReductionRule::None,
        OpCode::ConstInt => StrengthReductionRule::None,
        OpCode::ConstBigInt => StrengthReductionRule::None,
        OpCode::ConstFloat => StrengthReductionRule::None,
        OpCode::ConstStr => StrengthReductionRule::None,
        OpCode::ConstBool => StrengthReductionRule::None,
        OpCode::ConstNone => StrengthReductionRule::None,
        OpCode::ConstBytes => StrengthReductionRule::None,
        OpCode::Copy => StrengthReductionRule::None,
        OpCode::Import => StrengthReductionRule::None,
        OpCode::ImportFrom => StrengthReductionRule::None,
        OpCode::ModuleCacheGet => StrengthReductionRule::None,
        OpCode::ModuleCacheSet => StrengthReductionRule::None,
        OpCode::ModuleCacheDel => StrengthReductionRule::None,
        OpCode::ModuleGetAttr => StrengthReductionRule::None,
        OpCode::ModuleImportFrom => StrengthReductionRule::None,
        OpCode::ModuleGetGlobal => StrengthReductionRule::None,
        OpCode::ModuleGetName => StrengthReductionRule::None,
        OpCode::ModuleSetAttr => StrengthReductionRule::None,
        OpCode::ModuleDelGlobal => StrengthReductionRule::None,
        OpCode::ModuleDelGlobalIfPresent => StrengthReductionRule::None,
        OpCode::WarnStderr => StrengthReductionRule::None,
        OpCode::ScfIf => StrengthReductionRule::None,
...
/// ScevExprRule by opcode. EXHAUSTIVE over OpCode so a new opcode
/// cannot silently enter or miss this consumer through pass-local
/// wildcard/default logic.
#[inline]
pub fn opcode_scev_expr_rule_table(opcode: OpCode) -> ScevExprRule {
    match opcode {
        OpCode::Add => ScevExprRule::Add,
        OpCode::Sub => ScevExprRule::Sub,
        OpCode::Mul => ScevExprRule::Mul,
        OpCode::CheckedAdd => ScevExprRule::None,
        OpCode::CheckedMul => ScevExprRule::None,
        OpCode::InplaceAdd => ScevExprRule::None,
        OpCode::InplaceSub => ScevExprRule::None,
        OpCode::InplaceMul => ScevExprRule::None,
        OpCode::Div => ScevExprRule::None,
        OpCode::FloorDiv => ScevExprRule::None,
        OpCode::Mod => ScevExprRule::None,
        OpCode::Pow => ScevExprRule::None,
        OpCode::Neg => ScevExprRule::None,
        OpCode::Pos => ScevExprRule::None,
        OpCode::Eq => ScevExprRule::None,
        OpCode::Ne => ScevExprRule::None,
        OpCode::Lt => ScevExprRule::None,
        OpCode::Le => ScevExprRule::None,
        OpCode::Gt => ScevExprRule::None,
        OpCode::Ge => ScevExprRule::None,
        OpCode::Is => ScevExprRule::None,
        OpCode::IsNot => ScevExprRule::None,
        OpCode::In => ScevExprRule::None,
        OpCode::NotIn => ScevExprRule::None,
        OpCode::BitAnd => ScevExprRule::None,
        OpCode::BitOr => ScevExprRule::None,
        OpCode::BitXor => ScevExprRule::None,
        OpCode::BitNot => ScevExprRule::None,
        OpCode::Shl => ScevExprRule::None,
        OpCode::Shr => ScevExprRule::None,
        OpCode::And => ScevExprRule::None,
        OpCode::Or => ScevExprRule::None,
        OpCode::Not => ScevExprRule::None,
        OpCode::Bool => ScevExprRule::None,
        ...
        OpCode::DelAttr => ScevExprRule::None,
        OpCode::Index => ScevExprRule::None,
        OpCode::StoreIndex => ScevExprRule::None,
        OpCode::DelIndex => ScevExprRule::None,
        OpCode::DeleteVar => ScevExprRule::None,
        OpCode::Call => ScevExprRule::None,
        OpCode::CallMethod => ScevExprRule::None,
        OpCode::CallMethodIc => ScevExprRule::None,
        OpCode::CallSuperMethodIc => ScevExprRule::None,
        OpCode::CallBuiltin => ScevExprRule::None,
        OpCode::OrdAt => ScevExprRule::None,
        OpCode::BoxVal => ScevExprRule::None,
        OpCode::UnboxVal => ScevExprRule::None,
        OpCode::TypeGuard => ScevExprRule::None,
        OpCode::IncRef => ScevExprRule::None,
        OpCode::DecRef => ScevExprRule::None,
        OpCode::DelBoundary => ScevExprRule::None,
        OpCode::BuildList => ScevExprRule::None,
        OpCode::BuildDict => ScevExprRule::None,
        OpCode::BuildTuple => ScevExprRule::None,
        OpCode::BuildSet => ScevExprRule::None,
        OpCode::BuildSlice => ScevExprRule::None,
        ...
        OpCode::Raise => ScevExprRule::None,
        OpCode::CheckException => ScevExprRule::None,
        OpCode::ExceptionPending => ScevExprRule::None,
        OpCode::FunctionDefaultsVersion => ScevExprRule::None,
        OpCode::TryStart => ScevExprRule::None,
        OpCode::TryEnd => ScevExprRule::None,
        OpCode::StateBlockStart => ScevExprRule::None,
        OpCode::StateBlockEnd => ScevExprRule::None,
        OpCode::ConstInt => ScevExprRule::None,
        OpCode::ConstBigInt => ScevExprRule::None,
        OpCode::ConstFloat => ScevExprRule::None,
        OpCode::ConstStr => ScevExprRule::None,
        OpCode::ConstBool => ScevExprRule::None,
        OpCode::ConstNone => ScevExprRule::None,
        OpCode::ConstBytes => ScevExprRule::None,
        OpCode::Copy => ScevExprRule::None,
        OpCode::Import => ScevExprRule::None,
        OpCode::ImportFrom => ScevExprRule::None,
        OpCode::ModuleCacheGet => ScevExprRule::None,
        OpCode::ModuleCacheSet => ScevExprRule::None,
        OpCode::ModuleCacheDel => ScevExprRule::None,
        OpCode::ModuleGetAttr => ScevExprRule::None,
        OpCode::ModuleImportFrom => ScevExprRule::None,
        OpCode::ModuleGetGlobal => ScevExprRule::None,
        OpCode::ModuleGetName => ScevExprRule::None,
        OpCode::ModuleSetAttr => ScevExprRule::None,
        OpCode::ModuleDelGlobal => ScevExprRule::None,
        OpCode::ModuleDelGlobalIfPresent => ScevExprRule::None,
        OpCode::WarnStderr => ScevExprRule::None,
        OpCode::ScfIf => ScevExprRule::None,
...
pub fn opcode_exception_region_nesting_role_table(opcode: OpCode) -> ExceptionRegionNestingRole {
    match opcode {
        ...
        OpCode::CallMethodIc => ExceptionRegionNestingRole::None,
        OpCode::CallSuperMethodIc => ExceptionRegionNestingRole::None,
...
pub fn opcode_alias_transparent_alias_role_table(opcode: OpCode) -> AliasTransparentAliasRole {
    match opcode {
        ...
        OpCode::CallMethodIc => AliasTransparentAliasRole::NotTransparentAlias,
        OpCode::CallSuperMethodIc => AliasTransparentAliasRole::NotTransparentAlias,
...
pub fn opcode_alias_memory_region_table(opcode: OpCode) -> AliasMemoryRegionClass {
    match opcode {
        ...
        OpCode::CallMethodIc => AliasMemoryRegionClass::GenericHeap,
        OpCode::CallSuperMethodIc => AliasMemoryRegionClass::GenericHeap,
...
pub fn opcode_alias_slot_observation_table(opcode: OpCode) -> AliasSlotObservation {
    match opcode {
        ...
        OpCode::CallMethodIc => AliasSlotObservation::DirectObserver,
        OpCode::CallSuperMethodIc => AliasSlotObservation::DirectObserver,
...
pub fn opcode_pass_delta_facts_table(opcode: OpCode) -> PassDeltaOpcodeFacts {
    match opcode {
        ...
        OpCode::CallMethodIc => PassDeltaOpcodeFacts {
            generic_call: true,
            method_call: true,
            ..PASS_DELTA_OPCODE_FACTS_NONE
        },
        OpCode::CallSuperMethodIc => PassDeltaOpcodeFacts {
            generic_call: true,
            method_call: true,
            ..PASS_DELTA_OPCODE_FACTS_NONE
        },
...
pub fn opcode_operand_ownership_table(opcode: OpCode, operand_idx: usize) -> OperandOwnership {
    match opcode {
        ...
        OpCode::CallMethodIc => OperandOwnership::Borrowed,
        OpCode::CallSuperMethodIc => OperandOwnership::Borrowed,
...
pub fn opcode_result_validity_table(opcode: OpCode, result_idx: usize) -> ResultValidity {
    match opcode {
        ...
        OpCode::CallMethodIc => ResultValidity::AlwaysValid,
        OpCode::CallSuperMethodIc => ResultValidity::AlwaysValid,
...
pub fn opcode_explicit_release_operands_table(
    ...
    match opcode {
        ...
        OpCode::CallMethodIc => ExplicitReleaseOperands::None,
        OpCode::CallSuperMethodIc => ExplicitReleaseOperands::None,
