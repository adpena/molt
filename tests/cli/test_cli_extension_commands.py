    ...
    source.write_text(
        "\n".join(
            [
                ...
                "    int overflowed_int = npy_mul_with_overflow_int(&product, 2, 3);",
                "    (void)dispatch_info;",
                "    (void)total;",
                "    (void)product;",
                "    (void)overflowed;",
    ...
    source.write_text(
        "\n".join(
            [
                ...
                "    PyArray_Descr *(*descr_new_from_type)(int) = PyArray_DescrNewFromType;",
                ...
                "    int (*descr_converter2)(PyObject *, PyArray_Descr **) = PyArray_DescrConverter2;",
                "    int (*bool_converter)(PyObject *, npy_bool *) = PyArray_BoolConverter;",
                "    int (*intp_converter)(PyObject *, PyArray_Dims *) = PyArray_IntpConverter;",
                "    PyArray_Descr *(*discovery_fn)(PyObject *, PyArray_Descr *, int) = PyArray_DTypeFromObjectStringDiscovery;",
                "    int (*pack_fn)(PyArray_Descr *, void *, PyObject *) = PyArray_Pack;",
                "    PyArray_Descr *(*adapt_fn)(PyArrayObject *, PyArray_DTypeMeta *, PyArray_Descr *) = PyArray_AdaptDescriptorToArray;",
                "    int (*convert_axis_fn)(PyObject *, int, npy_bool *) = PyArray_ConvertMultiAxis;",
                "    PyArray_GetItemFunc *getitem = arrfuncs.getitem;",
                "    PyArray_CopySwapFunc *copyswap = arrfuncs.copyswap;",
                "    PyArray_Descr descr = {.type_num = NPY_DATETIME};",
                "    npy_packed_static_string *packed = NULL;",
                "    int integer_scalar = PyArray_IsIntegerScalar(Py_None);",
                "    int datetime_flag = PyDataType_ISDATETIME(&descr);",
                "    int default_type = NPY_DEFAULT_TYPE;",
                ...
                "    (void)descr_new_from_type;",
                "    (void)default_descr;",
                "    (void)scalar_fn;",
                "    (void)return_fn;",
                "    (void)descr_converter2;",
                "    (void)bool_converter;",
                "    (void)intp_converter;",
                "    (void)discovery_fn;",
                "    (void)pack_fn;",
                "    (void)adapt_fn;",
                "    (void)convert_axis_fn;",
                "    (void)getitem;",
                "    (void)copyswap;",
                "    (void)packed;",
                "    return (int)Py_SIZE(&void_scalar) + (dtype_flags == 0) + integer_scalar + datetime_flag + default_type;",
                "}",
                "",
            ]
        )
    ...
    source.write_text(
        "\n".join(
            [
                ...
                "    PyTypeObject *mappingproxy_type = &PyDictProxy_Type;",
                "    PyTypeObject *memoryview_type = &PyMemoryView_Type;",
                "    PyTypeObject *base_type = &PyBaseObject_Type;",
                "    int (*dict_merge)(PyObject *, PyObject *, int) = PyDict_Merge;",
                "    PyObject *(*tuple_slice)(PyObject *, Py_ssize_t, Py_ssize_t) = PyTuple_GetSlice;",
                "    PyObject *(*call_one_arg)(PyObject *, PyObject *) = PyObject_CallOneArg;",
                "    PyObject *unicode_decode_error = PyExc_UnicodeDecodeError;",
                "    (void)weak_obj;",
                "    (void)dict_ptr;",
                "    (void)tstate;",
                "    (void)present;",
                ...
                "    (void)is_weak;",
                "    (void)finalizing;",
                "    (void)mappingproxy_type;",
                "    (void)memoryview_type;",
                "    (void)base_type;",
                "    (void)dict_merge;",
                "    (void)tuple_slice;",
                "    (void)call_one_arg;",
                "    (void)unicode_decode_error;",
                "    Py_XDECREF(attr);",
                "    Py_DECREF(name);",
                "    return 0;",
                "}",
