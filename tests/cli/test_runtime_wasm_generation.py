...
def test_publish_self_validation_survives_a_concurrent_manifest_replacement(
    ...
    winner_manifest_text = winner.manifest.read_text(encoding="utf-8")
    original_write = module._atomic_write_text

    def write_then_lose_the_race(path: Path, text: str) -> None:
        ...
        if path == winner.manifest:
            ...
            original_write(path, winner_manifest_text)

    monkeypatch.setattr(module, "_atomic_write_text", write_then_lose_the_race)
