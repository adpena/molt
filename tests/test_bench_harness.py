...
def test_bench_harness_supports_explicit_molt_profile(
    ...
    monkeypatch.setattr(bench_harness, "collect_bench_scripts", lambda filter_pat=None: [])
    ...
    monkeypatch.setattr(bench_harness, "print_summary_table", lambda *args, **kwargs: None)
