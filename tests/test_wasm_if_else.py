...
def test_wasm_if_else_parity(tmp_path: Path) -> None:
    ...
    runner.write_text(
        ...
        "    vec_sum_int: () => 0n,\n"
        "    vec_sum_int_trusted: () => 0n,\n"
        "    vec_sum_int_range: () => 0n,\n"
        "    vec_sum_int_range_trusted: () => 0n,\n"
        "    vec_prod_int: () => 0n,\n"
        "    vec_prod_int_trusted: () => 0n,\n"
        "    vec_prod_int_range: () => 0n,\n"
        "    vec_prod_int_range_trusted: () => 0n,\n"
        "    vec_min_int: () => 0n,\n"
        "    vec_min_int_trusted: () => 0n,\n"
        "    vec_min_int_range: () => 0n,\n"
        "    vec_min_int_range_trusted: () => 0n,\n"
        "    vec_max_int: () => 0n,\n"
        "    vec_max_int_trusted: () => 0n,\n"
        "    vec_max_int_range: () => 0n,\n"
        "    vec_max_int_range_trusted: () => 0n,\n"
