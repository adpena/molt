"""Purpose: CPython 3.12+ builtins semantic probe for symbol `input`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _input_capture_case() -> object:
    old = sys.stdin
    try:
        sys.stdin = io.StringIO("molt-user\n")
        return SYMBOL("name: ")
    finally:
        sys.stdin = old


_record("target_input_capture_case", _input_capture_case)
