"""Purpose: CPython 3.12+ builtins semantic probe for symbol `compile`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _compile_expression_case() -> object:
    code = SYMBOL("sum(i*i for i in range(5))", "<expr>", "eval")
    return {
...
_record("target_compile_expression_case", _compile_expression_case)
