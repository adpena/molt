"""Purpose: CPython 3.12+ builtins semantic probe for symbol `super`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _super_mro_case() -> object:
    ...
    class Child(Base):
        def render(self) -> str:
            return SYMBOL().render() + "->child"

    return Child().render()


_record("target_super_mro_case", _super_mro_case)
