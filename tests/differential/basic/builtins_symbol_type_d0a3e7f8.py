"""Purpose: CPython 3.12+ builtins semantic probe for symbol `type`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _type_dynamic_class_case() -> object:
    cls = SYMBOL("Report", (), {"kind": "daily", "value": 5})
    instance = cls()
    return {"name": cls.__name__, "kind": instance.kind, "value": instance.value}


_record("target_type_dynamic_class_case", _type_dynamic_class_case)
