"""Purpose: CPython 3.12+ builtins semantic probe for symbol `print`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _print_capture_case() -> object:
    buf = io.StringIO()
    with contextlib.redirect_stdout(buf):
        SYMBOL("alpha", 7, sep="|", end="!")
    return buf.getvalue()


_record("target_print_capture_case", _print_capture_case)
