...
def _exec_scope_case() -> object:
    ns: dict[str, object] = {"values": [2, 3, 5]}
    SYMBOL("total = sum(values)\nvalues.append(total)", ns, ns)
    return ns["values"]


_record("target_exec_scope_case", _exec_scope_case)
_record("target_exec_class_body", _exec_class_body_case)
