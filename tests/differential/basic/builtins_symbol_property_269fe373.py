"""Purpose: CPython 3.12+ builtins semantic probe for symbol `property`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _property_descriptor_case() -> object:
    class Invoice:
    ...
    return Invoice(10, 3).total


_record("target_property_descriptor_case", _property_descriptor_case)
