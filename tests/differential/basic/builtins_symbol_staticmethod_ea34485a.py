"""Purpose: CPython 3.12+ builtins semantic probe for symbol `staticmethod`."""
import builtins
import contextlib
import hashlib
import inspect
...
def _staticmethod_case() -> object:
    class FX:
        @SYMBOL
        def convert(amount: int, rate: int) -> int:
            return amount * rate

    return FX.convert(7, 3)


_record("target_staticmethod_case", _staticmethod_case)
