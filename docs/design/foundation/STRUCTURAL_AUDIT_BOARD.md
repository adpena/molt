...
| --- | --- | --- | --- |
| medium | god_file | `src/molt/stdlib/asyncio/__init__.py` | 6270 lines (ceiling 2500) |
...
| --- | --- | --- | --- |
| medium | 6270 lines (ceiling 2500) | `src/molt/stdlib/asyncio/__init__.py` | extract cohesive submodules along legible seams (Lattner: one responsibility per |
