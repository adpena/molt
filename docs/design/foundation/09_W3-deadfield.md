...
### File 3: `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/module_phase.rs` (minor)
...
- **`/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/call_graph.rs`** — already correct; does not treat `func_new` as a call edge. No change.
- **`/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/module_phase.rs`** — no change; per-attribute DCE fires before TIR lifting.
