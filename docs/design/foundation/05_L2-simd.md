...
`Dialect::Simd` at `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/ops.rs:17` has zero ops defined. The existing 4x unroll in `function_compiler.rs:30815-30980` is the only "vectorization" in the entire system, and it is a scalar loop with width 4 on the SimpleIR path, entirely disjoint from TIR.
...
### Create: `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/vectorize_lower.rs`
...
### Modify: `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/ops.rs`
...
### Modify: `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/vectorize.rs`
...
### Modify: `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/effects.rs`
...
### Modify: `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/alias_analysis.rs`
...
### Modify: `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/verify.rs`
...
**Files changed:**
- `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/ops.rs`: add 9 new `OpCode` variants under `Dialect::Simd`
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/effects.rs`: classify the 9 new opcodes
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/vectorize.rs`: add the new opcodes to the `is_disqualifying` / `is_scalar_arithmetic` arms as non-disqualifying iteration infrastructure
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/alias_analysis.rs`: classify `VecLoad` → `MemRegion::Heap` read, `VecStore` → write
...
**Files changed:**
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/vectorize_lower.rs`: new file, full implementation for the conservative first-cut (FlatListInt + RawI64Safe + no EH + sum/product/elementwise)
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/mod.rs`: add `pub mod vectorize_lower`
- `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/pass_manager.rs`: insert `vectorize_lower` after `vectorize`, update pipeline order tests
...
- `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/verify.rs`: accept Simd ops
