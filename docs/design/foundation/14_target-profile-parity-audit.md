...
- `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/target_info.rs` — lines 246–311 (TargetInfo constructors; `BuildProfile` field exists but dev-fast vs release-fast never changes a pass decision)
