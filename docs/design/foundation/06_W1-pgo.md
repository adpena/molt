...
### 3.4 `runtime/molt-passes/src/tir/passes/loop_unroll.rs` — Profile-directed Trip Cap
...
### 3.5 `runtime/molt-passes/src/tir/passes/inliner.rs` — Profile-directed Inline Budget
...
### 3.8 `runtime/molt-ir/src/tir/function.rs` — Block Order Hint (W1-b)
...
**File to create:** `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/pgo_annotate.rs`
...
### 3.10 `runtime/molt-passes/src/tir/passes/mod.rs` + `pass_manager.rs` — Pipeline Slot
...
- Create `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/pgo_annotate.rs` as a `ReadOnly` no-op pass.
...
| `pgo_annotate` pass | `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/pgo_annotate.rs` | New file (ReadOnly no-op first cut) |
| Pipeline registration | `/Users/adpena/Projects/molt/runtime/molt-passes/src/tir/passes/mod.rs` + `pass_manager.rs` | Add pass slot |
| `block_order_hint` field | `/Users/adpena/Projects/molt/runtime/molt-ir/src/tir/function.rs` | Extend struct (W1-b) |
