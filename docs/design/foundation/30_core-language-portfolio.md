...
**MIDSTREAM.** Add/Sub/Mul are first-class TIR opcodes. Div/FloorDiv/Mod/Pow/Neg/Pos: first-class opcodes in `TirOp::OpCode`. Matmul: emits JSON kind `"matmul"`, mapped to `OpCode::Copy{_original_kind="matmul"}` — NOT promoted. CheckedAdd: first-class (ops.rs:49), used by overflow_peel; this is the only overflow-safe binary op.
...
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/ops.rs` (OpCode enum, TirOp)
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/op_kinds_generated.rs` (kind_to_opcode table)
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/passes/iter_devirt.rs` (list loop devirt)
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/passes/range_devirt.rs` (range loop devirt)
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/passes/deforestation.rs` (genexpr fusion)
- `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/passes/overflow_peel.rs` (dual-loop int accumulator)
