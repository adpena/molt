...
**`/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/printer.rs`**
...
- [ ] Add `TirDumpConfig` struct to `/Users/adpena/Projects/molt/runtime/molt-backend/src/tir/printer.rs` with `from_env()`, `matches_func()`, `matches_pass()`.
...
- [ ] `git add runtime/molt-backend/src/tir/printer.rs runtime/molt-backend/src/tir/pass_manager.rs runtime/molt-backend/src/native_backend/simple_backend.rs && git commit -m "build: unified MOLT_TIR_DUMP + MOLT_VERIFY_ANALYSIS filter — Phase 1c DX arc"`.
