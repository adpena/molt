...
- **`src/molt/capability_policy.py`** / `config_resolution.py:43-48` — add ruff-style `extend-capabilities`; keep CLI syntax and policy resolution in the same capability authority. **(R1.3.)**
