...
**Document ID:** 0960
**Audience:** Investors, CTOs, Molt contributors, AI coding agents
...
This document defines the *only* primary Molt metrics.
New metrics require updating this file.

### Graph Compliance Rule
If a graph is generated:
- it must follow the layouts defined above
- deviations must be explicitly justified in-doc
- “custom” visualizations are not allowed in investor-facing material

### Demo Alignment Rule
Every demo must include:
> “Supports Metrics: X, Y, Z (from 0960)”

### Documentation Consistency
Performance claims must:
- tie to a metric here
- avoid vague language
- mark unmeasured claims as **aspirational**
...
- AI agents stay aligned automatically
