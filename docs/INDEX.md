...
- Orchestration claw-loop research map: [docs/SYMPHONY_CLAW_LOOP_RESEARCH.md](docs/SYMPHONY_CLAW_LOOP_RESEARCH.md)
- Orchestration quality score rubric: [docs/QUALITY_SCORE.md](docs/QUALITY_SCORE.md)
