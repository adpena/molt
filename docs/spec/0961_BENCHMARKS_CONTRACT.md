...
**Document ID:** 0961
**Status:** Canonical
**Audience:** Molt contributors, AI coding agents, performance engineers
...
- AI agents cannot “benchmark drift” into meaningless numbers
...
## 7. AI AGENT RULES (MANDATORY)

### 7.1 Benchmark creation
When an AI agent creates a benchmark:
- it must reference this document by ID
- it must emit machine-readable output
- it must map results to Metrics 0960

### 7.2 Benchmark interpretation
AI agents must:
- avoid cherry-picking metrics
- report P99 prominently
- avoid absolute claims

### 7.3 Regression handling
If a benchmark regresses:
- flag it
- do not hide it
- annotate possible causes

---

## 8. What this document forbids
