...
**Suggested deliverable:** `docs/spec/0016_VERIFIED_SUBSET_CONTRACT.md`
...
**Suggested deliverable:** `docs/spec/0017_TYPE_SYSTEM_AND_SPECIALIZATION.md`
...
**Suggested deliverable:** `docs/spec/0018_MOLT_PACKAGE_ABI.md`
...
**Suggested deliverable:** `docs/spec/0019_WASM_TARGETS_AND_CONSTRAINTS.md`
...
**Suggested deliverable:** `docs/spec/0020_RUNTIME_SAFETY_INVARIANTS.md`
...
**Suggested deliverable:** `docs/spec/0021_REPRODUCIBLE_AND_DETERMINISTIC_MODE.md`
...
**Suggested deliverable:** `docs/spec/0022_BINARY_SIZE_AND_COLD_START.md`
...
- `docs/spec/0099_REPO_REVIEW_2026-01-07.md` (time-stamped review; add more later)
- `docs/spec/STATUS_AND_NEXT.md` (living document; keep updated)
