...
- Type Facts Artifact via `molt check` (`docs/spec/areas/compiler/0920_TYPE_FACTS_ARTIFACT_TY_INTEGRATION.md`)
...
## 7. Roadmap Links
- Type facts pipeline: `docs/spec/areas/compiler/0920_TYPE_FACTS_ARTIFACT_TY_INTEGRATION.md`.
- Strict tier rules: `docs/spec/areas/runtime/0922_STRICT_TIER_RULES_FOR_TRUSTED_TYPES.md`.
