...
| --- | --- | --- | --- |
| 3156 | asyncio core | partial | Core loop/task/future APIs covered; event loop policies, transports, protocols, and watchers missing (see table). |
...
| `AbstractChildWatcher` | test_subprocess.py, test_unix_events.py | basic: asyncio_api_surface_core.py | basic |
...
| `FastChildWatcher` | test_unix_events.py | basic: asyncio_api_surface_core.py | basic |
...
| `PidfdChildWatcher` | test_subprocess.py, test_unix_events.py | basic: asyncio_api_surface_core.py | basic |
...
| `SafeChildWatcher` | test_events.py, test_streams.py, test_unix_events.py | basic: asyncio_api_surface_core.py | basic |
...
| `ThreadedChildWatcher` | test_unix_events.py, utils.py | basic: asyncio_api_surface_core.py | basic |
...
| `get_child_watcher` | test_subprocess.py | basic: asyncio_api_surface_modules.py | basic |
...
| `set_child_watcher` | test_events.py, test_streams.py, test_subprocess.py | basic: asyncio_api_surface_modules.py | basic |
