...
- Follow `docs/spec/areas/wasm/0400_WASM_PORTABLE_ABI.md` for buffer conventions.
...
- `effects`: conservative effect declaration (see `docs/spec/areas/compiler/0202_FOREIGN_FUNCTION_BOUNDARY.md`)
...
- WASM packages must use ptr+len buffers per `docs/spec/areas/wasm/0400_WASM_PORTABLE_ABI.md`.
