...
## 1. Methodology
- **Baselines**: Compare against CPython 3.12 (standard), PyPy (when a compatible
  PyPy release exists), and optional Cython/Numba baselines when the `bench`
  dependency group is installed with Python 3.12.
- **Environment**:
