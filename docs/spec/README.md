...
- GVN numbering-role classifiers: `gvn_always_numberable_opcodes`, `gvn_type_gated_numberable_opcodes`, and `gvn_value_keyed_constant_opcodes` in [runtime/molt-tir/src/tir/op_kinds.toml](../../runtime/molt-tir/src/tir/op_kinds.toml), generating `opcode_gvn_numbering_role_table` for [runtime/molt-tir/src/tir/passes/gvn.rs](../../runtime/molt-tir/src/tir/passes/gvn.rs)
...
- Exception label opcode facts: `exception_label_attr_opcodes` and `exception_transfer_edge_opcodes` in [runtime/molt-tir/src/tir/op_kinds.toml](../../runtime/molt-tir/src/tir/op_kinds.toml), consumed by dominator, lowering, inliner, and generator-fusion exception-label remapping paths
