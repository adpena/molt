...
- Raw-i64 guard classifiers: `i64_zero_divisor_guard_opcodes` and `i64_shift_count_guard_opcodes` in [runtime/molt-backend/src/tir/op_kinds.toml](../../runtime/molt-backend/src/tir/op_kinds.toml), consumed by [runtime/molt-backend/src/tir/lower_to_lir.rs](../../runtime/molt-backend/src/tir/lower_to_lir.rs), [runtime/molt-backend/src/tir/passes/check_exception_elim.rs](../../runtime/molt-backend/src/tir/passes/check_exception_elim.rs), and [runtime/molt-backend/src/tir/passes/licm.rs](../../runtime/molt-backend/src/tir/passes/licm.rs)
- Literal payload and canonicalize opcode facts: `literal_payload_opcodes`, `canonicalize_commutative_reorder`, `canonicalize_swapped_comparison`, and `canonicalize_binary_rules` in [runtime/molt-backend/src/tir/op_kinds.toml](../../runtime/molt-backend/src/tir/op_kinds.toml), consumed by [runtime/molt-backend/src/tir/passes/canonicalize.rs](../../runtime/molt-backend/src/tir/passes/canonicalize.rs) and [runtime/molt-backend/src/tir/passes/check_exception_elim.rs](../../runtime/molt-backend/src/tir/passes/check_exception_elim.rs)
- Exception label opcode facts: `exception_label_attr_opcodes` and `exception_transfer_edge_opcodes` in [runtime/molt-backend/src/tir/op_kinds.toml](../../runtime/molt-backend/src/tir/op_kinds.toml), consumed by dominator, lowering, inliner, and generator-fusion exception-label remapping paths
