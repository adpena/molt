...
| REVIEW-14-SPECIALIZED-LIST-SLICE-FLAT-BUILDER | Codex/codex-review14-specialized-list-slice-20260708 | 2026-07-08T22:40:16Z | COMPLETE | Landed 9a9b840146. object::builders now owns flat specialized-list allocation; list[int]/list[bool] slice, copy, repeat, and molt_list_int_new preserve flat storage without temp boxed Vec. Proof: cargo test -p molt-runtime specialized_list --lib (5 passed, 484 filtered out). |
