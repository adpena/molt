...
- **#16 SCCP float/repr constant-fold parity: LANDED** (`af7fe19820` +
  ...
  regime (`0x4289368ec8725340` rounds differently). `repr(str)` still folds
  only byte-for-byte safe printable ASCII and defers quote/escape cases. Latest
  proof: proof-queue run
  `20260708T230715-review16-float-repr-corrective-rebased-molt-passes-lib-20c8382bbd214c70`
  (`cargo test -p molt-passes --lib`: `842 passed`).
