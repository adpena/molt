...
| 10 | wasm-browser split | startup | Measure browser `instantiateStreaming` independently | 4 | 4 | 1.00 | DOCUMENTED-BLOCKED OPT-MATRIX-R8: 178.2 ms serial vs 198.6 ms streaming median; clone/tee overhead regresses startup 11.4% |
